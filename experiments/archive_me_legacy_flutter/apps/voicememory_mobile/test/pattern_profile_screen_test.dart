...
void main() {
  ...
  testWidgets('legacy profile hides missing optional sections', (tester) async {
    await _pump(
      tester,
      profile: const PatternProfile(patternTitle: 'Legacy pattern'),
    );

    expect(tester.takeException(), isNull);
    expect(find.text('Legacy pattern'), findsOneWidget);
    expect(find.text('What ArchiveMe remembers'), findsNothing);
    expect(find.text('Pattern map'), findsNothing);
    expect(find.text('Pattern timeline'), findsNothing);
