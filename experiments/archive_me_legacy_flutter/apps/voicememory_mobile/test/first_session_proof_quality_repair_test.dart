...
void main() {
  ...
  group('FirstSessionCaptureRepair', () {
    ...
    test('copy keeps the first moment low effort', () {
      expect(
        FirstSessionProofRepairCopy.captureBody,
        contains('Skip the long write-up'),
      );
      expect(
        FirstSessionProofRepairCopy.captureBody.toLowerCase(),
        isNot(contains('journal entry')),
      );
    });
