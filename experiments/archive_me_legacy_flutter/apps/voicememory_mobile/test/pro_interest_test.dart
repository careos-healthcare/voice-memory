...
import 'package:voicememory_mobile/features/pro_interest/pro_interest_engine.dart';
import 'package:voicememory_mobile/features/pro_interest/pro_interest_gates.dart';
...
import 'package:voicememory_mobile/widgets/pro_interest_link_card.dart';
...
void main() {
    ...
    test('shows captured yes/no and pricing signal label', () {
      final snapshot = outcomesEngine.build(
        BetaOutcomesInput(
          ...
          proInterestState: const ProInterestState(
            selectedValueIds: [
              ProInterestValueId.longerArchiveHistory,
  ...
  group('Pro interest gates and routing', () {
    ...
    test('route is sensitive and linked from Pro Preview and Support', () {
      ...
      final preview = File(
        'lib/screens/pro_value_preview_screen.dart',
      ).readAsStringSync();
      final support = File(
