...
import 'package:voicememory_mobile/features/beta_decision_rules/beta_decision_rule_copy.dart';
import 'package:voicememory_mobile/features/beta_decision_rules/beta_decision_rule_engine.dart';
import 'package:voicememory_mobile/features/beta_decision_rules/beta_decision_rule_model.dart';
...
void main() {
  ...
  group('BetaDecisionRuleCard', () {
    ...
    testWidgets('shows counted inputs', (tester) async {
      ...
      expect(find.textContaining('First-moment saves: 2/10'), findsOneWidget);
