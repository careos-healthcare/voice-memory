...
void main() {
  group('Onboarding fallback', () {
    ...
    test('fallback body explains the core product vision', () {
      expect(
        AcquisitionStartCopy.capacityBody.toLowerCase(),
        allOf(
          contains('private voice journal'),
          contains('unified life story'),
  ...
  group('Daily change fallback', () {
    ...
    test('quick capture still work maps to fewer moments not more', () {
      expect(
        ArchiveDailyChangeCopy.quickCaptureStillWorkLine.toLowerCase(),
        allOf(
          contains('fewer moments'),
          contains('not more'),
