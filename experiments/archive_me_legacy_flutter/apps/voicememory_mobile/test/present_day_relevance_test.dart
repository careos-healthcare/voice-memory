...
import 'package:voicememory_mobile/features/present_day_relevance/present_day_relevance_analytics.dart';
import 'package:voicememory_mobile/features/present_day_relevance/present_day_relevance_copy.dart';
...
import 'package:voicememory_mobile/widgets/patterns/present_day_relevance_card.dart';
...
List<JournalEntry> _softeningEntries() => [
  ...
  _entry(
    '4',
    'I said yes again with no capacity, but this time it felt easier to stop.',
...
void main() {
  ...
  group('PresentDayRelevanceEngine', () {
    ...
    test('unclear state copy says lightly in view', () {
      final result = PresentDayRelevanceResult(
        shouldShow: true,
        entryCount: 3,
        source: 'test',
