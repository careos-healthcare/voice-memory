...
import 'package:voicememory_mobile/features/what_to_notice_next/what_to_notice_next_analytics.dart';
import 'package:voicememory_mobile/features/what_to_notice_next/what_to_notice_next_copy.dart';
import 'package:voicememory_mobile/features/what_to_notice_next/what_to_notice_next_engine.dart';
import 'package:voicememory_mobile/features/what_to_notice_next/what_to_notice_next_model.dart';
import 'package:voicememory_mobile/models/journal_entry.dart';
import 'package:voicememory_mobile/models/reflection.dart';
import 'package:voicememory_mobile/models/sync_status.dart';
import 'package:voicememory_mobile/widgets/record/what_to_notice_next_card.dart';
...
void main() {
  ...
  group('WhatToNoticeNextEngine', () {
    ...
    test('hidden while recording', () {
      ...
      final result = _buildResult([_entry('1', _strongRepeat)]);
      expect(
        _shouldShow(result: result, entryCount: 1, isRecording: true),
        isFalse,
      );
    });
    ...
    test('hidden post-save', () {
      ...
      final result = _buildResult([_entry('1', _strongRepeat)]);
      expect(
        _shouldShow(result: result, entryCount: 1, isPostSave: true),
        isFalse,
      );
    });
