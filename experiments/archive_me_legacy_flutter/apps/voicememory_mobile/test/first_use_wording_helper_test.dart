...
import 'package:voicememory_mobile/features/first_use_wording/first_use_wording_analytics.dart';
import 'package:voicememory_mobile/features/first_use_wording/first_use_wording_copy.dart';
import 'package:voicememory_mobile/features/first_use_wording/first_use_wording_model.dart';
    ...
    Future<void> pumpRecord(WidgetTester tester, {int entryCount = 0}) async {
      if (entryCount > 0) {
        await tester.runAsync(
          () => AppServices.instance.journalStore.replaceAll([
