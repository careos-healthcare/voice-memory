...
List<JournalEntry> _triggerAndBehaviourEntries() => [
  ...
  _entry(
    '4',
    'I had no capacity and said yes again right after the extra meeting ask came in.',
...
void main() {
  ...
  group('PatternMatchQualityEngine', () {
    ...
    test('grounded repeated behaviour scores solid', () {
      final result = _qualityFor(_triggerAndBehaviourEntries());
      expect(
        result.matchedDimensions,
        contains(PatternMatchDimension.sameBehaviour),
      );
      expect(
