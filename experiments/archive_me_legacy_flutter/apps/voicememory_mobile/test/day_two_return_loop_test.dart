...
void main() {
  group('DayTwoReturnLoopPayoffEngine', () {
    test('one entry uses calm return copy and optional reminder', () {
      ...
      expect(payoff.primaryCta, DayTwoReturnLoopPayoffCopy.primaryCta);
  ...
  group('DayTwoReturnLoopCard', () {
    testWidgets('shows calm reminder offer when enabled', (tester) async {
      ...
      expect(find.text(DayTwoReturnLoopPayoffCopy.primaryCta), findsOneWidget);
  ...
  group('RecordScreen return loop', () {
    ...
    testWidgets('first save shows return loop without competing preview card', (
      ...
      expect(find.text(DayTwoReturnLoopPayoffCopy.primaryCta), findsWidgets);
      expect(
    ...
    testWidgets('third save uses first-proof payoff without duplicate return loop', (
      tester,
    ) async {
      await pumpDoneState(
        tester,
