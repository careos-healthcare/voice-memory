...
import 'package:voicememory_mobile/features/pricing_value_framing/pricing_value_framing_analytics.dart';
import 'package:voicememory_mobile/features/pricing_value_framing/pricing_value_framing_copy.dart';
import 'package:voicememory_mobile/features/pricing_value_framing/pricing_value_framing_engine.dart';
...
void main() {
  ...
  group('protected areas', () {
    test('no fake locked content or paywall screen changes', () {
      final recordScreen = readRecordingFeatureSource();
