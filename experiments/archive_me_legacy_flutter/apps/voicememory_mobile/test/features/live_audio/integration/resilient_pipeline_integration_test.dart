...
class _ResilientPipelineHarness {
  factory _ResilientPipelineHarness({
    ...
    return _ResilientPipelineHarness._(
      vaultDirectory: vaultDirectory,
      vaultKeyProvider: vaultKeyProvider,
      pcmSent: pcmSent,
      failReconnectMint: failReconnectMint,
      journalFile: journalFile,
    );
  }

  _ResilientPipelineHarness._({
    required this.vaultDirectory,
    required this.vaultKeyProvider,
    required List<List<int>> pcmSent,
    required this.failReconnectMint,
  ...
  final VaultKeyProvider vaultKeyProvider;
