...
import 'package:voicememory_mobile/features/curiosity_loop/presentation/weekly_productivity_report_screen.dart';
...
void main() {
  ...
  setUp(() async {
    await AppServices.resetForTest(
      journalPath:
          '${Directory.systemTemp.createTempSync('weekly_report_j_')}/journal.json',
      prefsPath:
          '${Directory.systemTemp.createTempSync('weekly_report_p_')}/prefs.json',
      skipRevenueCat: true,
    );
  });
