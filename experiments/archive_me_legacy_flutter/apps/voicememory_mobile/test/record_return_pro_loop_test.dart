...
void main() {
  ...
  group('Copy guardrails', () {
    ...
    test('Pro bridge copy is exact', () {
      expect(RecordReturnProCopy.proTitle, FirstThreeSessionCopy.proTitle);
      expect(RecordReturnProCopy.proBody, FirstThreeSessionCopy.proBody);
      expect(
  ...
  group('Widgets', () {
    ...
    testWidgets('Pro bridge copy is exact', (tester) async {
      ...
      expect(find.text(FirstThreeSessionCopy.proTitle), findsOneWidget);
      expect(find.text(FirstThreeSessionCopy.proBody), findsOneWidget);
      expect(
        find.text(FirstThreeSessionCopy.proContinuityLine),
        findsOneWidget,
      );
      expect(
