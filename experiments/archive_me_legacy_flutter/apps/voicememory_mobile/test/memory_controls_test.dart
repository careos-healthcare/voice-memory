...
import 'package:voicememory_mobile/widgets/memory/memory_used_indicator.dart';
...
void main() {
  ...
  group('Treat this as new', () {
    ...
    testWidgets('V1 focused record surface hides advanced memory controls', (
      tester,
    ) async {
      ...
      expect(find.text(EntryMemoryModeCopy.treatAsNewLabel), findsNothing);
