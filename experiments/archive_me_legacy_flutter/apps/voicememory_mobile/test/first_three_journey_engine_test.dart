  ...
  test('3 reflections without repeat match stays on useful-archive copy', () {
    final m = engine.build(
      ...
      entries: [
        _entry(
          'a',
          'A quiet afternoon walk through the park felt restorative.',
        ),
        _entry('b', 'Groceries and laundry took most of the evening hours.'),
        _entry('c', 'The museum visit sparked a fresh idea for the project.'),
      ],
    );
      ...
      await pumpCard(
        ...
        engine.build(
          ...
          entries: [
            ...
            _entry(
              'b',
              'Groceries and laundry took most of the evening hours.',
            ),
            _entry(
              'c',
              'The museum visit sparked a fresh idea for the project.',
            ),
          ],
        ),
      );
