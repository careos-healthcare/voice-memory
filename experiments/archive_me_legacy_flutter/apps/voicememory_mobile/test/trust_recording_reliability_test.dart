...
import 'package:voicememory_mobile/widgets/record/capture_recovery_hint_strip.dart';
...
class _RecoveryFailingAnalyzeApi extends VoiceCaptureApiClient {
  ...
  group('Microphone permission copy', () {
    test('denied copy is calm and actionable', () {
      ...
      expect(
        ...
        contains('First Three Journey'),
      );
      expect(
        MicrophonePermissionCopy.deniedBody,
        contains('enable microphone access in your device settings'),
      );
      expect(
        MicrophonePermissionCopy.deniedBody,
        contains('Recordings stay in app-private storage'),
      );
      expect(
  ...
  group('Recording and save failure copy', () {
    ...
    test('local text save failure throws not saved copy', () async {
      ...
      await AppServices.resetForTest(
        ...
        skipRevenueCat: true,
        voiceCaptureApi: _RecoveryFailingAnalyzeApi(),
      );
