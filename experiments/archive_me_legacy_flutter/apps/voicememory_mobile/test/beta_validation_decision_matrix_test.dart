...
import 'package:voicememory_mobile/features/beta_validation_decision_matrix/beta_validation_decision_matrix_copy.dart';
import 'package:voicememory_mobile/features/beta_validation_decision_matrix/beta_validation_decision_matrix_engine.dart';
...
void main() {
  ...
  group('BetaValidationDecisionMatrixCard', () {
    testWidgets('renders all metrics with actual/target', (tester) async {
      ...
      expect(find.text('First-moment saves: 5/5'), findsOneWidget);
