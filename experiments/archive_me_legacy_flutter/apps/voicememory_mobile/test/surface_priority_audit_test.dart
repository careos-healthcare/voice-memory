...
import 'package:voicememory_mobile/features/surface_priority/surface_priority_analytics.dart';
...
void main() {
  ...
  group('SurfacePriorityEngine record ready', () {
    ...
    test('keeps capture controls primary', () {
      ...
      expectRecordScreenLayoutBefore(
        earlier: '_buildCaptureEntryActions',
  ...
  group('Surface priority integration', () {
    ...
    test('Archive tab delegates to the focused intelligence presentation', () {
      final source = File(
        'lib/screens/archive_belief_screen.dart',
      ).readAsStringSync();
      expect(source, contains('ArchiveIntelligencePresentation.build'));
      expect(source, contains('ArchiveIntelligenceHome'));
      expect(source, isNot(contains('SurfacePriorityEngine.auditPatterns')));
    });
  });
}
