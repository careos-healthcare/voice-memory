...
void main() {
  ...
  group('Patterns screen isolation', () {
    test('archive screen delegates to the focused presentation home', () {
      final source = File(
        'lib/screens/archive_belief_screen.dart',
      ).readAsStringSync();
      expect(source.contains('ReturnCheckPayoffCard'), isFalse);
      expect(source.contains('what_changed_since_last_time_card'), isFalse);
      expect(source.contains('ArchiveIntelligencePresentation.build'), isTrue);
      expect(source.contains('ArchiveIntelligenceHome'), isTrue);
    });
  });
}
