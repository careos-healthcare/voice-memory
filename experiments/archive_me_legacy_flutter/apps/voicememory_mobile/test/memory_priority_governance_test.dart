...
import 'package:voicememory_mobile/features/memory/memory_priority_score.dart';
...
import 'package:voicememory_mobile/features/memory/memory_visibility_receipt.dart';
...
void main() {
  ...
  group('Priority ladder', () {
    ...
    test('retrieval similarity alone cannot create important/essential', () {
      final records = [
        _rec(id: 'u0', daysAgo: 2, optionId: 'could_not_stop'),
