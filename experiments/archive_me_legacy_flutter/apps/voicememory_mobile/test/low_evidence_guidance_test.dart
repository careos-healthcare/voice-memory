...
import 'package:voicememory_mobile/features/low_evidence/low_evidence_model.dart';
...
import 'package:voicememory_mobile/widgets/record/low_evidence_guidance_card.dart';
...
Future<void> _pumpRecordReady(
  ...
  if (entries != null) {
    await tester.runAsync(() async {
      await AppServices.instance.journalStore.replaceAll(entries);
    });
  }
