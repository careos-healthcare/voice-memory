...
void main() {
  ...
  group('ThreeDayChallenge copy guard', () {
    test('no fake proof or medical therapy claims', () {
      ...
      expect(blob, contains('speak your thoughts'));
      expect(blob, contains('build one life story'));
      expect(blob, contains('discover personal intelligence'));
      expect(blob, contains('keep it private'));
    });
  });
