...
import 'package:voicememory_mobile/features/archive_explanations/belief_timeline_engine.dart';
import 'package:voicememory_mobile/features/archive_explanations/cross_reference_engine.dart';
...
void main() {
  ...
  test('belief timeline engine tracks monthly strength', () {
    final entries = List.generate(
      ...
      (i) => _entry(
        id: 'tl$i',
        at: DateTime(2026, 1, 1).add(Duration(days: i * 5)),
