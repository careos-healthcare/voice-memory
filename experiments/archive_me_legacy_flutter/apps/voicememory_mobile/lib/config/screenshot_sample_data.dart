...
abstract class ScreenshotSampleData {
  ...
  static const heroWhy =
      'Your saved words often link pressure with carrying more than your share, '
  ...
  static ArchiveBeliefCardModel get heroBelief => ArchiveBeliefCardModel(
    ...
    evidenceSummary: 'Based on 12 saved moments.',
  ...
  static ReturnComparison get returnComparisonSample => ReturnComparison(
    ...
    body:
        ...
        "Today's moment mentioned saying yes too quickly again.",
  ...
  static TomorrowReturnLoop get tomorrowReturnLoop => TomorrowReturnLoop(
    ...
    comeBackTomorrow:
        'After another moment tomorrow, ArchiveMe can compare '
  ...
  static ArchiveInsightsSnapshot get insightsSnapshot {
    final blindSpot = ArchiveInsight(
      ...
      archiveConclusion:
          'Support language is scarce across recent saved words.',
    );
