...
class TomorrowReturnLoopEngine {
  ...
  String _comeBackTomorrow({
    ...
    if (discoverFeed != null && discoverFeed.newItems.isNotEmpty) {
      ...
      return 'After one or two more moments, ArchiveMe can tell if '
    ...
    if (beliefs != null && beliefs.changing.isNotEmpty) {
      return 'Something is shifting in your moments. Tomorrow’s Patterns '
    ...
    return 'Each moment updates your patterns. A quick visit tomorrow '
