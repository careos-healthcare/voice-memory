...
import 'daily_discovery_models.dart';
import 'daily_discovery_store.dart';
      ...
      if (!priorIds.contains(report.id)) {
        out.add(
          DailyDiscovery(
            ...
            summary:
                'Two moments pull apart: “${_truncate(report.originalStatement, 70)}” vs “${_truncate(report.conflictingStatement, 70)}”.',
            whyItMatters:
                'When two moments pull apart, it often marks competing needs — '
      ...
      if (!currentIds.contains(priorId)) {
        out.add(
          DailyDiscovery(
            ...
            summary:
                'An earlier contradiction is no longer showing up in your latest saved moments.',
            whyItMatters:
  ...
  void _detectChapterTransition(
    ...
    out.add(
      DailyDiscovery(
        ...
        summary: 'The archive grouped recent moments into “${chapter.title}”.',
        whyItMatters:
  ...
  void _detectEmotionalShift(
    ...
    out.add(
      DailyDiscovery(
        ...
        summary:
            'Recent moments carry $direction emotional intensity than your prior baseline in the archive.',
        whyItMatters:
