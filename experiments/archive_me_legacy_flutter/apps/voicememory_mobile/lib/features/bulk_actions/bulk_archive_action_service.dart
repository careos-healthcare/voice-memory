...
class BulkArchiveActionService {
  BulkArchiveActionService({
    ...
    this._checkIns,
    this._collections,
    Future<void> Function(String id)? deleteEntry,
  }) : _deleteEntry = deleteEntry ?? _journal.delete;

  final JournalStore _journal;
  final PressureCheckInStore? _checkIns;
  final ArchiveCollectionStore? _collections;
  final Future<void> Function(String id) _deleteEntry;
  ...
  static JournalEntry _copy(
    ...
    localAudioVaultRef: e.localAudioVaultRef,
