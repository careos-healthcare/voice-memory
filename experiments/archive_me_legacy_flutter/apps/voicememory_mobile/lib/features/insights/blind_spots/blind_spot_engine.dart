...
class BlindSpotInsightEngine {
  ...
  BlindSpotInsight? _topicBlindSpot(
    ...
    final summary =
        '$title appears in $pct% of saved moments, but enjoyment or satisfaction '
    ...
    return BlindSpotInsight(
      ...
      metricValue: '$pct% of saved moments',
    );
  }
    ...
    return [
      BlindSpotInsight(
        ...
        summary:
            ...
            'saved moments) but rarely discuss satisfaction (${satisfactionHits.length} mentions).',
        confidence: 64,
        evidenceCount: achievementHits.length,
        supportingEvidence: evidence,
        metricLabel: 'Achievement mentions',
        metricValue: '${achievementHits.length} saved moments',
      ),
    ];
  }
