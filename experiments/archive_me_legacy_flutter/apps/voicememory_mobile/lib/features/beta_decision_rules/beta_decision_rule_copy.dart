...
abstract final class BetaDecisionRuleCopy {
  ...
  static const localCountsNote =
      'Counts are local metadata only. No saved words are shown.';

  static const testerCountLabel = 'Testers';
  static const firstSessionSaveLabel = 'First-moment saves';
  ...
  static String bodyFor(BetaDecisionRuleOutcome outcome) => switch (outcome) {
    ...
    BetaDecisionRuleOutcome.fixOpeningScreenOnly =>
      'First-moment saving is still too low. Do not touch proof or Pro yet. Make the first action clearer and smaller.',
    BetaDecisionRuleOutcome.fixProPlacement =>
      'First-moment saving improved, but Pro is still too hidden. Move the Pro moment closer to useful proof.',
  ...
  static String ctaFor(BetaDecisionRuleOutcome outcome) => switch (outcome) {
    ...
    BetaDecisionRuleOutcome.fixOpeningScreenOnly => 'Review first moment',
