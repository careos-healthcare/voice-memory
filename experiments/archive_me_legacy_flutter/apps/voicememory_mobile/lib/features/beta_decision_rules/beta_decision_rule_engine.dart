...
import 'beta_decision_rule_copy.dart';
...
abstract final class BetaDecisionRuleEngine {
  ...
  static String reasonFor({
    ...
    BetaDecisionRuleOutcome.fixOpeningScreenOnly =>
      'First-moment saves (${input.firstSessionSaveCount}/10) are still at or '
    ...
    BetaDecisionRuleOutcome.fixProPlacement =>
      'First-moment saves improved (${input.firstSessionSaveCount}/10 ≥ '
    ...
    BetaDecisionRuleOutcome.continueMoreTesters =>
      'All gates passed: first-moment saves (${input.firstSessionSaveCount}/10), '
