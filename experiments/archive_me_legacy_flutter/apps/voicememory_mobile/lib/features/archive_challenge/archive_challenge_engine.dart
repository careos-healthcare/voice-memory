...
import 'archive_challenge_store.dart';
...
class ArchiveChallengeEngine {
  ...
  void _detectWorkOverestimation(
    ...
    out.add(
      ArchiveChallenge(
        ...
        body:
            'You frame work as the main problem in $workFraming recent moments, '
  ...
  void _detectConfidenceVsRelationships(
    ...
    out.add(
      ArchiveChallenge(
        ...
        body:
            'Saved moments naming confidence as a struggle: $confidenceProblem. '
  ...
  void _detectUncertaintyVsFailure(
    ...
    final ids = <String>{...uncertainIds, ...failureIds}.take(4).toList();
    if (ids.length < minEvidenceCount) return;
