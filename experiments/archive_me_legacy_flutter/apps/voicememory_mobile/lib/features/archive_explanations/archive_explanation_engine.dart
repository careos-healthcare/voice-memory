...
class ArchiveExplanationEngine {
  ...
  @Deprecated('Use intelligenceEngine')
  DiscoverYourselfEngine get discoverEngine =>
      intelligenceEngine.discoveryEngine;
  ...
  ArchiveExplanation? _beliefChangeExplanation(
    ...
    return ArchiveExplanation(
      ...
      whySummary:
          ...
          '${change.evidenceEntryIds.length} saved moments support this shift.',
      supportingEvidence: supporting,
  ...
  ArchiveExplanation? _themeExplanation(
    ...
    return ArchiveExplanation(
      ...
      title: theme.name,
      explanation:
          '“${theme.name}” shows up in ${theme.frequency} saved moments. '
  ...
  ArchiveExplanation? _contradictionExplanation(
    ...
    return ArchiveExplanation(
      ...
      whySummary:
          'You opened a paired contrast between moments recorded on different days.',
      supportingEvidence: supporting,
  ...
  ArchiveExplanation? _weeklyStoryExplanation(
    ...
    return ArchiveExplanation(
      ...
      title: 'Your week in saved moments',
      explanation:
          '${story.reflectionCountThisWeek} saved moments this week; '
  ...
  ArchiveExplanation? _askExplanation(
    ...
    final prompt =
        ...
        'What changed most?';
    final answer = intelligenceEngine.answerArchiveQuestion(
      prompt: prompt,
      entries: entries,
      state: state,
    );
  ...
  String _whyBeliefBody(String belief, int evidenceCount) {
    return 'The archive weighs $evidenceCount saved moments where your language '
