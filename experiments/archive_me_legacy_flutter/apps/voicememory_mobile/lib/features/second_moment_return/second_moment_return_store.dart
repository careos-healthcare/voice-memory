...
/// Local dismiss state for second-moment return — today only, no network.
class SecondMomentReturnStore {
  SecondMomentReturnStore(this._prefs);

  static const dismissPrefsKey = 'secondMomentReturnDismiss_v1';
  ...
  static SecondMomentReturnStore instance() =>
      SecondMomentReturnStore(AppServices.instance.prefs);

  static SecondMomentReturnStore forPrefs(MobilePrefsStore prefs) =>
      SecondMomentReturnStore(prefs);
