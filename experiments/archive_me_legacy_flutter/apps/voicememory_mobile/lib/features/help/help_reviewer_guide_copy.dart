...
abstract final class HelpReviewerGuideCopy {
  ...
  static const appReviewAccessTitle = 'App Review Access (recommended)';
  static const appReviewAccessBody =
      'In review builds, open Settings and enter the review code from App Review notes. '
      'This loads sample archive entries, unlocks the evidence trail and paywall for testing, '
      'and enables Pro features without purchase.';
  static const appReviewAccessSettingsHint =
      'Settings → App Review Access → enter review code';
  static const appReviewAccessActiveTitle = 'Review access is active';
  static const appReviewAccessActiveBody =
      'The main Archive tab uses sample entries with confirmed repeat proof. '
      'You can open the paywall and restore flow without completing a real purchase.';
