...
const Map<String, Map<String, String>> _copy = {
  'en': {
    ...
    'reflectionLanguageTitle': 'Moment language',
  ...
  'es': {
    ...
    'reflectionLanguageTitle': 'Idioma del momento',
  ...
  'fr': {
    ...
    'reflectionLanguageTitle': 'Langue du moment',
  ...
  'hi': {
    ...
    'reflectionLanguageTitle': 'क्षण की भाषा',
  ...
  'gu': {
    ...
    'reflectionLanguageTitle': 'ક્ષણની ભાષા',
