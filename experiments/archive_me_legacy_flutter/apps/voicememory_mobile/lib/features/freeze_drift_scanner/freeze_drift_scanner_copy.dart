...
abstract final class FreezeDriftScannerCopy {
  ...
  static const headline = 'Release scope scanner';

  static const body =
      'During release candidate freeze, scan changes for risky scope expansion '
      'and allow only release blocker fixes.';

  static const riskyLine =
      'Risky scope expansion: new surfaces, dashboards, reports, rankings, action items, '
  ...
  static const blockedLine =
      'Risky scope expansion detected. Stop the change and fix only release blockers.';

  static const allowedChangeLine =
      'Change fits release freeze. Blocker fix only, no feature expansion.';

  static const freezeInactiveLine =
      'Release freeze is not active. Scope scan is informational only.';

  static const guardrail =
      'Release scope scanner protects release freeze. No product UI changes.';
