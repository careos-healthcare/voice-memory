...
import '../archive_packs/archive_pack.dart';
import '../collections/archive_collection.dart';
...
import '../memory/archive_thread.dart';
import '../memory/archive_retrieval_policy.dart';
import '../memory/memory_authority_framing_engine.dart';
import '../pressure_retention/pressure_check_in_record.dart';
import '../pressure_retention/pressure_context.dart';
import 'archive_search_filters.dart';
import 'archive_search_query.dart';
import 'archive_search_result.dart';
    ...
    for (final entry in entries) {
      ...
      results.add(
        ArchiveEntrySearchResult(
          ...
          entryTypeLabel: EntryAboutness.fromId(entry.entryAboutness).label,
