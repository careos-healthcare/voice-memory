...
class ArchiveQuestionEngine {
  ...
  static const _insufficientEvidenceAnswer =
      'Not enough saved moments with usable transcript detail yet — '
    ...
    switch (id) {
      case ArchiveQuestionId.why:
        return ArchiveQuestionAnswer(
          ...
          answerLines: [
            ...
            '${eligible.length} saved moments with usable transcripts',
          ],
        );
      ...
      case ArchiveQuestionId.whenDidThisStart:
        ...
        return ArchiveQuestionAnswer(
          ...
          answerLines: [
            'Earliest usable moment: ${first.month}/${first.day}/${first.year}.',
          ],
        );
      ...
      case ArchiveQuestionId.whatWouldChangeIt:
        return ArchiveQuestionAnswer(
          ...
          answerLines: const [
            'New moments that do not match patterns in existing transcripts.',
        ...
        return ArchiveQuestionAnswer(
          ...
          answerLines: [
            '${healthLabel(state.health)} — based on ${eligible.length} '
                'saved moment${eligible.length == 1 ? '' : 's'} with usable transcripts, '
