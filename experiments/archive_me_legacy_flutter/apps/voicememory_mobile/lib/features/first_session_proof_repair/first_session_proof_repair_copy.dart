...
abstract final class FirstSessionProofRepairCopy {
  ...
  static const captureBody =
      'Skip the long write-up. Save one sentence about something that feels familiar, unfinished, or hard to let go of.';
  ...
  static const focusFirstSessionCapture = 'Fix first-moment capture';
