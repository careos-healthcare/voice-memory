import '../commercial_proof_executor/commercial_proof_executor.dart';
import '../paid_intent_beta_proof/paid_intent_beta_proof.dart';
import '../release_evidence/release_evidence_pack.dart';
import '../revenuecat_live_proof/revenuecat_live_proof_runner.dart';
import '../secrets_rotation_gate/secrets_rotation_launch_gate.dart';
import 'single_launch_checklist_copy.dart';
...
abstract final class SingleLaunchChecklist {
  ...
  static const testFlightRequiredItems = [
    SingleLaunchChecklistItemId.cleanGit,
    SingleLaunchChecklistItemId.versionBuildSet,
    SingleLaunchChecklistItemId.physicalIphoneSmoke,
    SingleLaunchChecklistItemId.physicalIpadSmoke,
