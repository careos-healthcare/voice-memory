...
abstract final class FirstSessionLiftCopy {
  ...
  static const body =
      'Skip the long write-up. Save one moment that felt familiar, unfinished, or hard to let go of.';
  ...
  static const diagnosisFixFirstSessionCapture = 'Fix first-moment capture';
