...
class ArchiveInterpretationEngine {
  ...
  String _whatThisMightMean(
    ...
    switch (e.kind) {
      ...
      case ArchiveInsightKind.beliefChange:
        ...
        if (stats.uncertaintyMentions > stats.confidenceMentions &&
          ...
          sentences.add(
            'Language tied to “${_short(belief, 64)}” may be softening across recent moments.',
          );
          sentences.add(
          ...
          sentences.add(
            'The pattern might come from language you repeat when speaking aloud.',
          );
        }
      case ArchiveInsightKind.theme:
        ...
        if (stats.recentThemeMentions > stats.priorThemeMentions &&
          ...
          sentences.add(
            'Mentions of $theme appear more often in your recent eligible moments.',
          );
          sentences.add(
          ...
          sentences.add(
            '$theme shows up in ${stats.supportingCount} saved moments with usable transcripts.',
          );
          sentences.add(
      ...
      default:
        if (stats.workMentions > stats.relationshipMentions + 2 &&
          ...
          sentences.add(
            'The archive previously linked stress mostly to work in older moments.',
          );
          sentences.add(
    ...
    if (sentences.isEmpty) {
      ...
      sentences.add(
        'The meaning may stay open until more moments clarify the pattern.',
      );
    }
  ...
  InterpretationEvidenceSummary _supportsSummary(
    ...
    if (stats.recentSharePercent >= 55) {
      bullets.add('Increasing recently in eligible moments');
  ...
  InterpretationMindChange _mindChange(
    ...
    switch (e.kind) {
      ...
      case ArchiveInsightKind.beliefChange:
        ...
        weaker.add('the belief stops appearing in recent moments');
      case ArchiveInsightKind.theme:
        final theme = e.title.toLowerCase();
        stronger.add('$theme continues appearing in eligible moments');
        stronger.add(
      ...
      case ArchiveInsightKind.contradiction:
        ...
        weaker.add('one side disappears from recent eligible moments');
