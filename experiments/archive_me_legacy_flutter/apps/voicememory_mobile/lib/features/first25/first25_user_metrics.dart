...
abstract class First25UserMetrics {
  ...
  static Future<void> trackRecordingCreated({
    ...
    return ProductAnalytics.trackStrings(recordingCreated, {'source': source});
  }
  ...
  static Future<void> trackRecordingDay({
    ...
    return ProductAnalytics.trackStrings(event, {'cohort_day': '$day'});
  }

  static Future<void> trackArchiveOpened({required String surface}) async {
    await BetaActivationSummaryTracker.trackPatternsOpened();
    await ProductAnalytics.trackStrings(archiveOpened, {'surface': surface});
  }
