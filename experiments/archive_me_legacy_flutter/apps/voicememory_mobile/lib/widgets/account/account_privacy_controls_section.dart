...
class AccountPrivacyControlsSection extends StatefulWidget {
  const AccountPrivacyControlsSection({
    ...
    this.privacySnapshot = PrivacyCapabilitySnapshot.focusedV1,
  });
  ...
  final PrivacyCapabilitySnapshot privacySnapshot;
...
class _AccountPrivacyControlsSectionState
  ...
  Widget build(BuildContext context) {
    final privacySnapshot = AppServices.isInitialized
        ? widget.privacySnapshot.withRuntimeState(
            biometricLockEnabled:
                AppServices.instance.biometricVault?.isEnabled == true,
          )
        : widget.privacySnapshot;
    return Column(
      ...
      children: [
        ...
        Card(
          key: const Key('account_privacy_capability_summary'),
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: AppSpacing.sm),
                for (final statement in privacySnapshot.accountSummary)
                  Padding(
        ...
        if (ProductionNavigation.isNavRouteVisible('/archive-export'))
          _button(
