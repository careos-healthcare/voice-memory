...
class WeeklyPatternRecapCard extends StatefulWidget {
  ...
  static const String cta = 'Use this check';

  static const Color _surface = Color(0xFFF4F0FB);
  static const Color _border = Color(0xFFE0D6F2);

  @override
  State<WeeklyPatternRecapCard> createState() => _WeeklyRecapCardState();
}

class _WeeklyRecapCardState extends State<WeeklyPatternRecapCard> {
  @override
  void initState() {
    super.initState();
