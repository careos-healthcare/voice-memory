...
class DailyMirrorRecordCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (mirror.impossibleInsight case final insight?) {
      return Column(
        key: const Key('daily_mirror_impossible_insight'),
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          ExplainableConclusionCard(conclusion: insight.conclusion),
          const SizedBox(height: AppSpacing.sm),
          Text(
            insight.nextEvidenceQuestion,
            key: const Key('daily_mirror_impossible_next_question'),
