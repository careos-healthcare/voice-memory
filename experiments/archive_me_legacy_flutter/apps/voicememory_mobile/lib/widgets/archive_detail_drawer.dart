...
class ArchiveDetailDrawer extends StatelessWidget {
  ...
  static const _allItems = <({String label, String route})>[
    (label: 'Archive tools', route: '/archive-tools'),
    (label: 'Self-discovery', route: '/self-discovery'),
    (label: 'Archive', route: '/journal'),
  ];

  static List<({String label, String route})> get items => _allItems;
  ...
  static const _sheetSubtitle =
      'Saved moments and pattern review — deeper views of your archive.';
