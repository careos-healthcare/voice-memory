  ...
  Widget build(BuildContext context) {
    ...
    final child = Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text(
          '${BeliefProductCopy.savedMomentsCount(insight.evidenceCount)} · '
          '${insight.confidence}% ${ConsumerUiCopy.labelConfidence.toLowerCase()}',
          style: VoiceMemoryTypography.bodyStyle(),
        ),
        if (quote != null) ...[
          const SizedBox(height: AppSpacing.sm),
    ...
    return Column(
      ...
      children: [
        primary,
        const SizedBox(height: AppSpacing.sm),
        AiExplainabilityCard(explainability: insight.explainability),
      ],
    );
  }
