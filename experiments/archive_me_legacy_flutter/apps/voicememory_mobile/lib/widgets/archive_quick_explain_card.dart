...
class ArchiveQuickExplainCard extends StatelessWidget {
  ...
  String get _stageRange {
    if (reflectionCount <= 2) return 'Moment 1–2';
    if (reflectionCount <= 4) return 'Moment 3–4';
    return 'Moment 5+';
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Every saved moment becomes evidence. Beliefs strengthen, weaken, or disappear.',
