...
import '../../features/live_audio/presentation/widgets/live_voice_interactive_player_card.dart';
import '../../features/live_audio/presentation/live_voice_session_presentation.dart';
import '../../theme/voicememory_colors.dart';
import '../audio_visualizer.dart';
import '../indigo_capture_waveform.dart';
import 'live_voice_speaking_waveform.dart';
...
class LiveVoiceStatusCard extends StatelessWidget {
  ...
  final LiveVoicePlaybackPlayer? playbackPlayer;
        ...
        child: Column(
          ...
          children: [
            ...
            if (showWaveform) ...[
              ...
              else if (audioDecibels case final decibels?)
                AudioVisualizer(decibels: decibels)
              else
            ...
            if (visualState == LiveVoiceVisualState.speaking &&
              ...
              LiveVoiceInteractivePlayerCard(
