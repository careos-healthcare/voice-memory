...
import '../features/early_insights/early_archive_insight_analytics.dart';
import '../features/early_insights/early_archive_wins.dart';
...
class _EarlyArchiveInsightCardState extends State<EarlyArchiveInsightCard> {
  ...
  String get _supportingLine => switch (widget.insight.kind) {
    EarlyArchiveInsightKind.topicInRecentWindow =>
      '$topic appears often in your recent moments — the archive is still gathering evidence.',
    EarlyArchiveInsightKind.patternMayBeForming =>
      '$topic shows up often across your archive. This may be worth watching as you add more moments.',
  };
