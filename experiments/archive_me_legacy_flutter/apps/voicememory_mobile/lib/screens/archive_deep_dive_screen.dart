...
import '../widgets/archive_v1/archive_explainable_conclusion_section.dart';
        ...
        children: [
          ...
          if (_narrative != null) ...[
            ...
            ArchiveExplainableConclusionSection(
              view: widget.v1,
              conclusions: [
                ..._narrative!.evidenceSynthesis,
                _narrative!.beliefEvolutionSummary,
              ],
            ),
            const SizedBox(height: 8),
            Text(
          ...
          const SizedBox(height: 8),
          Text(
            '${dive.why.evidenceCount} saved '
            'moment${dive.why.evidenceCount == 1 ? '' : 's'} · '
            '${dive.why.supportingRecordings} supporting '
            'recording${dive.why.supportingRecordings == 1 ? '' : 's'}',
            style: const TextStyle(color: AppTheme.muted, fontSize: 13),
          ),
