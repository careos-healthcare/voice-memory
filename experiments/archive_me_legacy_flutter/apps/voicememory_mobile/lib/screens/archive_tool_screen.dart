...
const _toolCopy = <String, _ToolCopy>{
  'belief-survival': _ToolCopy(
    ...
    lead:
        'How your working belief has held up as new moments arrive. '
  ...
  'contradictions': _ToolCopy(
    ...
    lead:
        'Moments when new saves pushed against what the archive believed. '
...
class _ArchiveToolScreenState extends State<ArchiveToolScreen> {
  ...
  Widget _beliefSurvivalBody() {
    ...
    if (!archiveHasMinimumEvidence(_entries)) {
      ...
      return Text(
        need > 0
            ? '$evidenceCount of $archiveMinEvidenceReflections saved moments with enough '
                  'transcript detail to track belief survival. Record $need more to continue.'
            : 'Add moments with at least $archiveMinTranscriptChars characters of '
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          '$evidenceCount moment${evidenceCount == 1 ? '' : 's'} support this belief '
        ...
        const Text(
          ...
          'experience; this device shows moment-backed counts only.',
    ...
    return Column(
      ...
      children: [
        const Text(
          ...
          'the strongest tension the archive can support from your saved words.',
          style: TextStyle(color: AppTheme.muted, height: 1.45),
        ),
        const SizedBox(height: 12),
        FilledButton(
          onPressed: () => context.go('/self-discovery?tab=blind-spots'),
