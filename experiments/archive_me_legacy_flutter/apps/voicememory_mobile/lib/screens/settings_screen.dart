...
import '../widgets/settings/remote_transcription_privacy_setting.dart';
      ...
      body: ArchiveResponsiveLayout.page(
        ...
        child: ListView(
          ...
          children: [
            ...
            const RemoteTranscriptionPrivacySetting(),
            const SizedBox(height: AppSpacing.md),
            ListTile(
              ...
              onTap: () => context.push(RouteCatalog.optionalContext),
            ),
            ListTile(
            ...
            if (ArchiveBetaMissionGate.isEnabled) ...[
              ...
              const SizedBox(height: AppSpacing.sm),
              const BetaConversionDiagnosisCard(source: 'settings'),
              const SizedBox(height: AppSpacing.sm),
