...
import '../features/archive_memory/archive_evolution_store.dart';
...
import '../features/archive_review/archive_range_review_store.dart';
...
import '../widgets/archive/archive_range_selector.dart';
...
class _ArchiveRangeReviewScreenState extends State<ArchiveRangeReviewScreen> {
  ...
  Future<void> _load() async {
    ...
    final isPro = (await _entitlementReader.entitlement).hasProAccess;
    final loopClosed =
