          ...
          child: ListView(
            ...
            children: [
              ...
              if (review.hasEnoughEvidence) ...[
                ...
                OutlinedButton(
                  key: const Key(
                    'weekly_archive_review_screen_review_ritual_link',
                  ),
                ...
                OutlinedButton(
                  key: const Key(
                    'weekly_archive_review_screen_milestone_share_link',
                  ),
              ...
              if (_nextMomentPrompt?.stage ==
                  NextMomentPromptStage.fivePlus) ...[
                const SizedBox(height: AppSpacing.lg),
                NextMomentPromptCard(
                  prompt: _nextMomentPrompt!,
                  onPrimary: () =>
                      _handleNextMomentPrompt(_nextMomentPrompt!.primaryAction),
