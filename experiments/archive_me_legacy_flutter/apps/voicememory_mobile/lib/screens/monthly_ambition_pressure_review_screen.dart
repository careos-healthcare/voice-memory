...
class _MonthlyAmbitionPressureReviewScreenState
  ...
  Future<void> _load() async {
    ...
    SubscriptionState? entitlements = widget.initialEntitlements;
    if (AppServices.isInitialized) {
      entitlements = await AppServices.instance.subscriptionRepository
          .refresh();
    }
    final canViewFull =
  ...
  bool get _billingReady =>
      widget.onSeePro != null ||
      (AppServices.isInitialized &&
          AppServices.instance.subscriptionRepository.availability ==
