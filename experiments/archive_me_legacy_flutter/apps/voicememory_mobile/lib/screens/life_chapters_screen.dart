...
class LifeChaptersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const PushedScreenShell(
      title: 'Life Chapters',
      body: LifeChaptersView(),
    );
  }
}

class LifeChaptersView extends StatefulWidget {
  const LifeChaptersView({super.key});

  @override
  State<LifeChaptersView> createState() => _LifeChaptersViewState();
}

class _LifeChaptersViewState extends State<LifeChaptersView> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              AiExplainabilityCard(explainability: chapter.explainability),
            ],
          ),
        ),
      ),
