      ...
      body: _loading
              ...
              child: Padding(
                ...
                child: Text(
                  _entries.length < WeeklyStoryEngine.minEntriesForCard
                      ? 'Record at least ${WeeklyStoryEngine.minEntriesForCard} moments '
                            'for a weekly story.'
          ...
          : ListView(
              ...
              children: [
                ...
                Text(
                  '${_story!.reflectionCountThisWeek} saved moments this week',
                  style: const TextStyle(color: AppTheme.muted),
                ),
                const SizedBox(height: 16),
                AudioDigestPlayerWidget(
                  narrative: const WeeklyStoryEngine().buildAudioRetrospective(
                    _story!,
                  ),
                ),
                const SizedBox(height: 16),
