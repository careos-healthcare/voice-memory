...
export default function EntryPage() {
  ...
  const handleDelete = () => {
    ...
    if (
      !window.confirm(
        "Delete this moment and its audio from this device? This cannot be undone.",
      )
    ) {
      return;
    }
      ...
      <div className="mx-auto max-w-3xl px-4 pb-24 sm:px-6">
        ...
        {loading ? (
          ...
          <MotionPage className="mt-16 text-center">
            <h1 className="text-lg font-normal text-zinc-100">Moment not found</h1>
            <p className="mt-2 text-sm text-muted">
              This link may be outdated, or the moment was removed from this device.
            </p>
            <Button asChild className="mt-6" variant="ghost">
              <Link href="/journal">Back to moments</Link>
            </Button>
          </MotionPage>
        ) : (
