...
export default function SettingsPage() {
  ...
  const handleDeleteAllLocal = async () => {
    ...
    try {
      ...
      showMessage(
        removed > 0
          ? `Deleted ${removed} moment${removed === 1 ? "" : "s"} and cleared local preferences.`
          ...
          <Card className="border-red-500/20">
            ...
            <CardContent>
              <p className="text-sm text-muted">
                Permanently removes moments, transcripts, audio, bookmarks, goals,
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-3">
                <p className="text-sm font-medium text-zinc-300">Recording goal</p>
                <p className="text-sm text-muted">
              ...
              <div className="space-y-3 border-t border-white/5 pt-6">
                ...
                <p className="text-sm text-muted">
                  Save recordings without looking for patterns right away. Your transcript and audio
                  are kept — you can look for patterns later when it feels right.
                </p>
                <Button
                  type="button"
