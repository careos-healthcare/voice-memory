...
export const MOBILE_ARCHIVE_SURFACES: MobileSurfaceSpec[] = [
  {
    surface: "archive",
    dartFiles: ["apps/voicememory_mobile/lib/screens/archive_belief_screen.dart"],
    expectedSectionLabels: ["Belief", "Trust", "Activity", "Progress", "Evidence"],
  },
  {
    surface: "changes",
    dartFiles: ["apps/voicememory_mobile/lib/screens/discover_screen.dart"],
    expectedSectionLabels: ["Archive Activity"],
  },
  {
    surface: "reflection_log",
    dartFiles: ["apps/voicememory_mobile/lib/screens/memory_screen.dart"],
    expectedSectionLabels: ["Reflection Log", "Memory"],
  },
  {
    surface: "account",
    dartFiles: ["apps/voicememory_mobile/lib/screens/account_screen.dart"],
