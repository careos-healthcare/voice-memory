...
export const MINI_WOW_COPY = {
  ...
  progressTowardReview: (count: number) =>
    `${count}/${BLIND_SPOT_MIN_REFLECTIONS} moments toward a stronger pattern review`,
  ...
  unlockedBody:
    "You have enough moments for a full blind spot review — still cautious, still tied to your words.",
