export const OPEN_LOOP_SECTION_TITLE = "Open loops";
export const OPEN_LOOP_SECTION_LEAD =
...
export const OPEN_LOOP_CLOSE_LABEL = "Mark closed";
export const OPEN_LOOP_SOFTEN_LABEL = "Soften";
export const OPEN_LOOP_KEEP_OPEN_LABEL = "Keep open";
