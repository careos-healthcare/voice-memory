...
function detectSoundDifferent(
  ...
  for (const past of [...prior].reverse()) {
    ...
    pushCandidate(notes, {
      ...
      text: "You sound very different from this version of yourself.",
...
function detectEmotionallySimilar(
  ...
  for (const past of [...prior].reverse()) {
    ...
    pushCandidate(notes, {
      ...
      text: "This sounds close to how you spoke about this before.",
...
function detectEarlierLoop(
  ...
  for (const past of [...prior].reverse()) {
    ...
    pushCandidate(notes, {
      ...
      kind: "earlier_loop",
      text: "This was an earlier version of this same loop.",
...
function detectBeforeDirectNaming(
  ...
  for (const theme of current.reflection.recurringThemes) {
    ...
    pushCandidate(notes, {
      ...
      text: "You had not started naming this directly yet.",
...
function detectMonthlyContrast(
  ...
  pushCandidate(notes, {
    ...
    text: "This reads differently from a couple of months ago.",
