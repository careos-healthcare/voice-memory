export const PERSONAL_HYPOTHESIS_DISCOVER = {
  heading: "See what changed",
  subheadline: "What changed since last time",
  lead: "Theory confidence, status, and evidence diffs since your last visit — measurement only.",
} as const;
