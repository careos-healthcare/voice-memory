...
import {
  ErrorBanner,
  ProcessingStatus,
} from "@/archived-components/_archived/InsightCardStatus";
...
import { FirstSessionValueCard } from "@/archived-components/_archived/archive/FirstSessionValueCard";
import { ReflectionImpactReceipt } from "@/archived-components/_archived/archive/ReflectionImpactReceipt";
import { WhatIsMyArchive } from "@/archived-components/_archived/archive/WhatIsMyArchive";
...
import { EvidenceArchivePreview } from "@/archived-components/_archived/product/EvidenceArchivePreview";
...
import { EvidenceBuildingCard } from "@/archived-components/_archived/theories/EvidenceBuildingCard";
import { ArchivePostSaveLoop } from "@/archived-components/_archived/recording/ArchivePostSaveLoop";
import { LowEffortMode } from "@/archived-components/_archived/recording/LowEffortMode";
...
import { MicPermissionPanel } from "@/archived-components/_archived/recording/MicPermissionPanel";
import {
...
import type { RecordUiPhase } from "@/archived-components/_archived/capture/RecordCaptureChrome";
...
export function Recorder({
  ...
  const postSaveBreakthrough = useMemo(() => {
    if (!postSaveEntries || !entry) return null;
    const summary = buildSessionMovementSummary(postSaveEntries, {
      newEntryId: entry.id,
    });
      ...
      <AnimatePresence mode="wait">
        ...
        {state === "complete" && entry && (
          ...
          >
            ...
            {!showPostSaveLoop && postSaveBreakthrough ? (
              <BreakthroughInsightCard
                headline={postSaveBreakthrough.headline}
                detailLine={postSaveBreakthrough.detailLine}
