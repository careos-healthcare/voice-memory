...
export const metadata: Metadata = {
  title: "Terms — Thoughtprint",
  description: `Terms of use for Thoughtprint — ${APP_DESCRIPTION_SHORT}`,
};
...
export default function TermsPage() {
  return (
    <TrustPageShell
      eyebrow="Legal"
      title="Terms of use"
      description="By using Thoughtprint you agree to these terms. Last updated for launch readiness."
    >
