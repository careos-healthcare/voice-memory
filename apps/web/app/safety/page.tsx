...
export const metadata: Metadata = {
  title: "Safety — Thoughtprint",
  description: "Thoughtprint is not therapy, not a diagnosis, and not crisis support. Crisis resources included.",
};
...
export default function SafetyPage() {
  return (
    <TrustPageShell
      ...
      description="Thoughtprint helps you notice patterns in your own words. It is not therapy, not crisis support, and never pressures you to keep recording."
    >
