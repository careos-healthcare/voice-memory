...
import { RecurrenceDensityDebugPanel } from "@/archived-components/_archived/debug/RecurrenceDensityDebugPanel";
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm">
          ...
          <Link href="/internal/first-week-retention" className="text-zinc-500 hover:text-zinc-300">
            First-week retention →
          </Link>
          <Link href="/internal/silence-intelligence" className="text-zinc-500 hover:text-zinc-300">
            Quiet mode →
          </Link>
        </div>
      </div>
