...
import { ResurfacingVarietyPanel } from "@/archived-components/_archived/debug/ResurfacingVarietyPanel";
    ...
    <div className="min-h-screen-mobile bg-zinc-950 pb-safe">
      <div className="mx-auto max-w-3xl px-4 pb-20 sm:px-6">
        ...
        <p className="mt-10 text-xs text-zinc-600">
          <Link href="/internal/behavior-truth" className="text-zinc-500 hover:text-zinc-300">
            Behavioral truth
          </Link>
          {" · "}
          <Link
            href="/internal/reflection-friction"
