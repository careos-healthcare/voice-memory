...
import { FirstMagicMomentDebugPanel } from "@/archived-components/_archived/debug/FirstMagicMomentDebugPanel";
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm">
          <Link href="/internal/return-triggers" className="text-violet-300 hover:text-violet-200">
            Return triggers →
          </Link>
          ...
          <Link href="/internal/onboarding-clarity" className="text-zinc-500 hover:text-zinc-300">
            Onboarding clarity →
          </Link>
        </div>
      </div>
