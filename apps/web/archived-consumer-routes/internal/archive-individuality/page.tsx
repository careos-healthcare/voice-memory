...
import { ArchiveIndividualityPanel } from "@/archived-components/_archived/debug/ArchiveIndividualityPanel";
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm">
          <Link href="/internal/archive-divergence" className="text-violet-300 hover:text-violet-200">
            Archive divergence →
          </Link>
