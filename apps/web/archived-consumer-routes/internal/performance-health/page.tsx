...
const PerformanceHealthPanel = dynamic(
  () =>
    import("@/archived-components/_archived/debug/PerformanceHealthPanel").then(
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm">
          <Link href="/internal/transcript-cleanup" className="text-violet-300 hover:text-violet-200">
            Transcript cleanup →
          </Link>
