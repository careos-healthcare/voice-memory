...
import { SacrednessReviewPanel } from "@/archived-components/_archived/debug/SacrednessReviewPanel";
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="mx-auto max-w-5xl px-4 pb-20 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm">
          ...
          <Link href="/internal/archive-individuality" className="text-zinc-500 hover:text-zinc-300">
