...
**Machine release truth:** from repo root run `npm run release:verify-focused-beta` before any TestFlight / Play upload. Gate statuses live in `release/focused_beta_status.json`.
