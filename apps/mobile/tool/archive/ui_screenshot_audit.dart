...
String _defaultRouterFilePath() {
  ...
  final candidates = [
    if (File('$cwd${Platform.pathSeparator}lib${Platform.pathSeparator}router${Platform.pathSeparator}app_router.dart').existsSync())
      '$cwd${Platform.pathSeparator}lib${Platform.pathSeparator}router${Platform.pathSeparator}app_router.dart',
    '$cwd${Platform.pathSeparator}apps${Platform.pathSeparator}mobile${Platform.pathSeparator}lib${Platform.pathSeparator}router${Platform.pathSeparator}app_router.dart',
  ];
