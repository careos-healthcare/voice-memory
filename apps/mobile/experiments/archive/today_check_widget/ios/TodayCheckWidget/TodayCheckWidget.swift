...
private struct QuickCaptureWidgetView: View {
  var body: some View {
    ...
    .background(
      LinearGradient(
        colors: [Color(red: 0.45, green: 0.22, blue: 0.92), Color(red: 0.18, green: 0.12, blue: 0.45)],
        startPoint: .topLeading,
        endPoint: .bottomTrailing
      )
    )
    .widgetURL(TodayCheckPayload.launchURL(for: "/record"))
  }
}
...
struct QuickCaptureWidget: Widget {
  ...
  var body: some WidgetConfiguration {
    ...
    .description("One tap to open Record from your home screen.")
