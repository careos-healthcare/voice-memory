...
import 'package:archiveme_mobile/features/voice_capture/transcription/provisional_transcript_reconcile_gateway.dart';
...
class AppServices {
  ...
  ProvisionalTranscriptReconcileGateway? _provisionalTranscriptReconcileGateway;
  ...
  static Future<void> initializeOptionalServices() async {
    ...
    _wireProvisionalTranscriptReconcile(s);
  ...
  static void _wireProvisionalTranscriptReconcile(AppServices s) {
    s._provisionalTranscriptReconcileGateway?.dispose();
    s._provisionalTranscriptReconcileGateway = ProvisionalTranscriptReconcileGateway(
      connectivity: s.liveVoiceConnectivity,
  ...
  Future<void> _switchToNamespace(
    ...
    _wireProvisionalTranscriptReconcile(this);
    oldBilling.dispose();
  ...
  static Future<void> resetForTest({
    ...
    s.sqliteDatabase = await AppSqliteDatabase.open(filePath: sqlitePath);
