...
part 'journal_display_settings.freezed.dart';

/// User-facing display, organization, and memory-scope metadata for a journal entry.
@Freezed(fromJson: false, toJson: false, copyWith: false)
abstract class JournalDisplaySettings with _$JournalDisplaySettings {
  const JournalDisplaySettings._();

  const factory JournalDisplaySettings({
  ...
  }) = _JournalDisplaySettings;

  factory JournalDisplaySettings.fromJson(Map<String, dynamic> json) {
    return JournalDisplaySettings(
  ...
  JournalDisplaySettings copyWith({
    bool? treatAsNew,
