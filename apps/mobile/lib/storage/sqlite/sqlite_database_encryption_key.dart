...
final class SqliteDatabaseEncryptionKey {
  const SqliteDatabaseEncryptionKey._(this.sqlcipherPassword, this._rawKeyBytes);
  ...
  Uint8List? get rawKeyBytes => _rawKeyBytes == null
      ? null
      : Uint8List.fromList(_rawKeyBytes!);
