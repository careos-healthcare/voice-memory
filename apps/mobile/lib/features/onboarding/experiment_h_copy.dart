/// Copy for Experiment H ("Not ChatGPT") onboarding proof.
abstract final class ExperimentHCopy {
  ExperimentHCopy._();
  ...
  static const assumptionCitable =
      'User-falsifiable citations — you can inspect and correct the source.';
}