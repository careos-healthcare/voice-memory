...
/// Last-write-wins rows and additive graph weights for a mesh peer.
///
...
/// only that device's share.
class DatabaseSyncMerger {
  DatabaseSyncMerger({required this.database, required this.deviceId}) {
