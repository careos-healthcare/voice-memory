...
abstract class ScreenshotSampleData {
  ...
  static ArchiveBeliefCardModel get heroBelief => const ArchiveBeliefCardModel(
    id: 'screenshot-hero',
  ...
  static FirstLoopActivationState firstLoopStateFor(String stage) {
    final opened = DateTime(2026, 5, 25, 9);
    switch (stage) {
      case 'saved':
  ...
  static ReturnDayFrictionState returnDayStateFor(String stage) {
    ...
    final shown = DateTime(2026, 5, 26, 9);
    switch (stage) {
      case 'answered':
  ...
  static WeeklyPatternRecap get weeklyRecapSample => const WeeklyPatternRecap(
