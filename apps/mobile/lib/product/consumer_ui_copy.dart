...
abstract class ConsumerUiCopy {
  ...
  // ——— Thoughtprint competitive positioning ———
  ...
  static const String patternsEarlyStateBody = 'Record a few real entries. Thoughtprint will look for what repeats across them.';
  ...
  // ——— Legacy loop-step copy (research / acquisition surfaces only) ———
  ...
  static const String onboardingFinalCta = OnboardingV1Copy.startCta;
  static const String onboardingContinueCta = OnboardingV1Copy.continueCta;
  static const String recordOneMomentCta = 'Record one entry';
  static const String recordMomentCta = 'Record entry';
  static const String stopRecordingCta = 'Stop recording';
  static const String doneCta = 'Done';
  static const String recordAnotherCta = 'Record';
  ...
  static const String firstRecordingHandoffCta = 'Record this entry';
  ...
  static const String nextEvidenceReminderBodyWithPrompt =
      'Thoughtprint is watching: {prompt}';
  ...
  static const String returnDayJourneyBodyTemplate =
      'Thoughtprint is watching: {title}. Record one more entry to test whether it repeats.';
  ...
  static const String returnDayEvidenceSavedTitle = 'Evidence recorded for today';
  ...
  static const String archiveMemoryDemoTitle = 'How Thoughtprint builds evidence';
  ...
  static const String archiveMemoryPreviewCta = 'Record one entry';
  ...
  static const String recordNextMomentCta = 'Record next entry';
  ...
  static const String archiveSearchLink = 'Search archive';
  ...
  static const String patternsRecordCta = 'Record';

  static const String patternsEmptyPageTitle = 'Record a few real entries';
  static const String patternsEmptyPageBody =
      VisibleArchiveProofCopy.patternsMindMapEmptyBody;
  static const String patternsFirstEntrySavedTitle = 'First entry recorded';
  static const String patternsFirstEntrySavedBody = 'Record one more clear entry and Thoughtprint can compare what repeats.';
  static const String patternsFirstEntrySavedHelper =
      VisibleArchiveProofCopy.patternsOneEntryReassurance;
  static const String patternsFirstEntrySavedCta = 'Record';
  static const String patternsFirstEntryViewSavedCta = 'View recorded entry';
  ...
  static const String patternsEmptyCta = 'Record entry';
  ...
  static const String allPatternsLead = 'Patterns and themes Thoughtprint keeps noticing in your reflections.';
  ...
  static const String changesScreenLead =
      ...
      'not conclusions.';
  static const String changesSectionCorrectionHint =
  ...
  static const String labelConfidence = 'How often it shows up';
  ...
  static const String labelMoments = 'Entries you mentioned';
  static const String labelWhatThisMeans = 'What this may mean';
  static const String detailMomentsSection = 'Entries from your reflections';
  ...
  static const String startRecording = 'Record';
  ...
  static const String reflectionSavedTitle = 'Reflection recorded';
  ...
  static const String postSaveRecordAnother = 'Record';
  static const String firstSignalSavedTitle = 'First signal recorded';
  ...
  static const String postSaveInsightSaveSignal = 'Record';
  ...
  static const String postSaveInsightSavedAck = 'Recorded as evidence.';
  static const String postSaveInsightEvidenceFromMoment = 'From your entry';
  static const String postSaveInsightWhySuggested =
      'Why Thoughtprint suggested this';
  static const String postSaveInsightEvidenceUsed = 'Evidence Thoughtprint used';
  ...
  static const String postSaveInsightNextPromptSaved = 'Next prompt recorded';
  static const String postSaveInsightMomentsProgress =
      '{count} of 3 entries recorded';
  ...
  static const String patternsWatchingSignalTitle = 'Thoughtprint is watching this signal';
  static const String patternsWatchingSignalBody = 'Record one more entry to test whether it repeats.';

  // ——— Signal archive surfaces ———
  static const String signalDetailEmptyTitle = 'No recorded signal yet';
  static const String signalDetailEmptyBody =
      'Record a entry and choose the read that feels closest.';
  static const String signalDetailRecordMoment = 'Record';
  ...
  static const String signalEvidenceSupporting = 'Supporting entries';
  ...
  static const String archiveWatchingTitle = 'Thoughtprint is watching';
  ...
  static const String archiveWatchingHypothesisLabel = 'Possible read';
  ...
  static const String archiveHomeEvidenceCount = 'Evidence entries';
  ...
  static const String signalJourneyWatchingTemplate =
      'Thoughtprint is watching: {title}.';
  static const String signalJourneyProgress =
      '{count} of {target} entries recorded';
  ...
  static const String signalJourneyCompletionRepeatedTemplate =
      '{title} showed up across {count} entries.';
  ...
  // ——— Signal review ———
  static const String signalReviewCardTitle = 'Thoughtprint reviewed this signal';
  ...
  static const String signalReviewRecordMoment = 'Record';
  ...
  static const String signalReviewSavedPattern = 'Recorded as a pattern to watch.';
  ...
  static const String signalReviewRepeatedTemplate =
      'So far, “{title}” seems to show up across {count} entries.';
  ...
  static const String secondSessionCompareTemplate =
      'The earlier entry was about {previous}. This one may be about {latest}.';
  ...
  static const String instantMomentsLabel = 'Entries you mentioned:';
  static const String showMoments = 'Show entries';
  static const String hideMoments = 'Hide entries';

  // ——— Account ———
  static const String accountTitle = 'Thoughtprint account';
  ...
  static const String protectPatternsCta = 'Record my patterns';
  ...
  static const String paywallPrimaryValueBlock = 'Pro keeps a longer private archive — more entries, more continuity, more evidence over time.';
  ...
  static const String paywallDifferentiation = 'Thoughtprint is not trying to answer better than ChatGPT. It is trying to remember differently.';
  static const String paywallTrust = 'Your entries stay free. Manage or cancel anytime in the App Store.';
  ...
  static const String narrativeWeakening =
  ...
  static const String patternsComeBackBody = 'Thoughtprint compares what you record over time.';
  ...
  static const String watchForResultBodyUnclear =
      "Today's moment was short. Record once more tomorrow and Thoughtprint "
  ...
  static const String returnComparisonBodyUnclear =
      "Today's reflection was short, so Thoughtprint needs another moment "
  ...
  static String weeklyRecapBodyFallback(int count) =>
      'You kept showing up $count times this week. Thoughtprint is starting to see what repeats.';

  // Legacy labels (older loop card)
  static const String tomorrowLoopTitle = 'Your return loop';
  static const String tomorrowNoticedToday = 'What Thoughtprint noticed today';
  ...
  static const String activePatternRecordTodayCta = 'Record today';
  ...
  static const String firstSessionWatchTomorrowSection = 'Tomorrow, look at this pattern';
  ...
  static const String resultNextCheckTitle = 'Next useful pattern';
  ...
  static const String patternsResultUseCheckCta = 'Use this pattern';
  ...
  static const String usefulTakeawayNextCheckLabel = 'Next pattern';
  ...
  static const String firstPatternAddAnotherMomentCta = 'Add another entry';
  ...
  static const String firstSessionSavedLine1 = 'Recorded.';
  static const String firstSessionSavedLine2 =
      'Tomorrow Thoughtprint will ask this exact question.';
  static const String tomorrowCheckInDueTitle = 'Your pattern from yesterday';
  ...
  static const String tomorrowCheckInRecordCta = 'Record one entry';
  ...
  static const String reminderSettingsTitle = 'Pattern reminders';
  ...
  static const String patternsRecordAnotherMomentCta = 'Record';
  ...
  static const String patternsCheckInWaitingTitle = 'Pattern waiting';
  static const String patternsCheckInWaitingBody = 'Thoughtprint has a question from your last entry.';
