...
import 'package:archiveme_mobile/push/push_background_handler.dart';
...
class FcmService {
  ...
  Future<void> _registerTokenSafe(String token) async {
    try {
      ...
      FcmLog.tokenRegistrationFailed(error: e, stackTrace: stackTrace);
    }
  }
  ...
  Future<void> initialize() async {
    ...
    if (!FirebaseBootstrap.isConfigured) {
      FcmLog.disabled(reason: 'firebase_not_configured');
      return;
    }

    final ready = await FirebaseBootstrap.tryInitialize();
    if (!ready || !Firebase.apps.isNotEmpty) {
      FcmLog.disabled(reason: 'firebase_unavailable');
      return;
    }
    ...
    try {
      ...
      _messaging = null;
      _initialized = false;
      FcmLog.setupFailed(error: e, stackTrace: stackTrace);
    }
  }
  ...
  Future<bool> requestPermission() async {
    ...
    try {
      ...
      FcmLog.requestPermissionFailed(error: e, stackTrace: stackTrace);
      return false;
    }
  }
