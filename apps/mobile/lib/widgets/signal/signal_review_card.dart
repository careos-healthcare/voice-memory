...
import 'package:archiveme_mobile/features/signal_review/signal_review_navigation.dart';
        ...
        children: [
          ...
          if (review.isActionable) ...[
            FilledButton(
              ...
              child: const Text(LoopModeCopy.reviewKeepWatchingLoop),
            ),
            const SizedBox(height: AppSpacing.xs),
            OutlinedButton(
              onPressed: onConfirm,
              child: const Text(LoopModeCopy.reviewFeelsRight),
            ),
            const SizedBox(height: AppSpacing.xs),
            OutlinedButton(
              onPressed: onCorrect,
              child: const Text(LoopModeCopy.reviewCorrect),
            ),
            const SizedBox(height: AppSpacing.xs),
            OutlinedButton(
          ...
          OutlinedButton(
            ...
            child: const Text(ConsumerUiCopy.signalReviewViewFull),
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          if (review.isActionable) ...[
            FilledButton(
              onPressed: onConfirm,
              child: const Text(ConsumerUiCopy.signalReviewFeelsRight),
            ),
            const SizedBox(height: AppSpacing.xs),
            OutlinedButton(
              onPressed: onCorrect,
              child: const Text(ConsumerUiCopy.signalReviewCorrectThis),
            ),
            const SizedBox(height: AppSpacing.xs),
            OutlinedButton(
              onPressed: onKeepWatching,
