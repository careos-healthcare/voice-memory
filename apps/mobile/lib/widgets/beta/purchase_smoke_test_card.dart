...
import 'package:archiveme_mobile/features/purchase_smoke_test/purchase_smoke_test_copy.dart';
import 'package:archiveme_mobile/features/purchase_smoke_test/purchase_smoke_test_engine.dart';
import 'package:archiveme_mobile/features/purchase_smoke_test/purchase_smoke_test_model.dart';
          ...
          Row(
            children: [
              TextButton(
                ...
                child: const Text(PurchaseSmokeTestCopy.refreshCta),
              ),
              const SizedBox(width: 8),
              TextButton(
                key: const Key('purchase_smoke_test_open_paywall'),
                onPressed: () => _openPaywall(snapshot),
                child: const Text(PurchaseSmokeTestCopy.openPaywallCta),
              ),
            ],
          ),
          const Text(
            PurchaseSmokeTestCopy.localNote,
            key: Key('purchase_smoke_test_note'),
            style: TextStyle(
              color: AppTheme.muted,
              fontSize: 12,
              height: 1.35,
