...
import 'package:archiveme_mobile/features/beta_test_script/beta_test_script_analytics.dart';
...
class _BetaTestScriptSheetState extends State<BetaTestScriptSheet> {
  ...
  void _trackStep(String stepKey) {
    ...
    unawaited(BetaTestScriptStore.instance().markStepSeen(stepKey));
  }
  ...
  Future<void> _confirmReset() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text(BetaTestScriptCopy.resetTitle),
        content: const Text(BetaTestScriptCopy.resetBody),
        actions: [
          TextButton(
            key: const Key('beta_test_script_reset_cancel'),
            onPressed: () => Navigator.of(dialogContext).pop(false),
            child: const Text(BetaTestScriptCopy.resetCancelCta),
          ),
          TextButton(
            key: const Key('beta_test_script_reset_confirm'),
            onPressed: () => Navigator.of(dialogContext).pop(true),
            child: const Text(BetaTestScriptCopy.resetConfirmCta),
          ),
        ],
      ),
    );
          ...
          children: [
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: const Text(BetaTestScriptCopy.sendBetaFeedbackCta),
              ),
            ),
            Align(
              alignment: Alignment.centerLeft,
              child: TextButton(
                ...
                child: const Text(BetaTestScriptCopy.resetProgressCta),
              ),
            ),
          ],
        ),
