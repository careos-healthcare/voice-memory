...
import 'package:archiveme_mobile/features/early_archive/weekly_archive_review_model.dart';
...
class WeeklyArchiveWeekReviewCard extends StatelessWidget {
  const WeeklyArchiveWeekReviewCard({
    required this.review, required this.showRecordCta, super.key,
    this.onRecord,
  });
          ...
          if (showRecordCta && onRecord != null) ...[
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: const Text(WeeklyArchiveWeekReviewCopy.recordCta),
              ),
            ),
          ],
        ],
