...
import 'package:archiveme_mobile/widgets/record/first_insight_sharpness_row.dart';
import 'package:archiveme_mobile/widgets/record/next_evidence_prompt_card.dart';
import 'package:archiveme_mobile/widgets/record/post_save_clearer_moment_banner.dart';
import 'package:archiveme_mobile/widgets/retention/reminder_pre_prompt_sheet.dart';
    ...
    return Column(
      ...
      children: [
        ...
        FilledButton(
          ...
          child: const Text(ConsumerUiCopy.postSaveInsightAbFeelsCloserA),
        ),
        const SizedBox(height: AppSpacing.xs),
        FilledButton(
          onPressed: busy ? null : onSelectB,
          child: const Text(ConsumerUiCopy.postSaveInsightAbFeelsCloserB),
        ),
        const SizedBox(height: AppSpacing.xs),
        OutlinedButton(
          onPressed: busy ? null : onNeither,
          child: const Text(ConsumerUiCopy.postSaveInsightAbNeither),
        ),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          FilledButton(
            ...
            child: const Text(ConsumerUiCopy.postSaveInsightFeelsTrue),
          ),
          const SizedBox(height: AppSpacing.xs),
          Row(
            children: [
    ...
    return _InsightPanel(
      ...
      actions: [
        FilledButton(
          ...
          child: const Text(ConsumerUiCopy.postSaveInsightSaveSignal),
        ),
        SizedBox(height: gap),
        OutlinedButton(
          onPressed: busy ? null : onAnotherAngle,
          child: const Text(ConsumerUiCopy.postSaveInsightAnotherAngle),
        ),
        const SizedBox(height: AppSpacing.xs),
        OutlinedButton(
        ...
        OutlinedButton(
          onPressed: busy
              ? null
              : () => SignalArchiveNavigation.openEvidenceTrail(context),
          child: const Text(ConsumerUiCopy.signalDetailViewEvidenceTrail),
        ),
      ],
    );
  }
      ...
      children: [
        ...
        if (onViewSignalDetail != null)
          FilledButton.tonal(
            ...
            child: const Text(ConsumerUiCopy.signalDetailViewSignal),
          ),
      ...
      children: [
        Align(
          ...
          child: TextButton.icon(
            ...
            label: const Text(ConsumerUiCopy.back),
          ),
        ),
        Text(
          title,
