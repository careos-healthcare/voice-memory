...
import 'package:archiveme_mobile/features/tomorrow_return/check_in_result_copy.dart';
...
class _TomorrowCheckInDueCardState extends State<TomorrowCheckInDueCard> {
  ...
  void _onRecord() {
    unawaited(ActivationTracker.trackCheckInMomentRecorded());
    unawaited(ActivationTracker.trackTomorrowCheckInRecordingStarted());
    (widget.onRecord ?? () {})();
  }
