...
class _ArchiveInsightFeedbackControlsState
  ...
  Future<void> _record(ArchiveInsightFeedbackChoice choice) async {
    ...
    await ArchiveInsightFeedbackStore.record(widget.insightId, choice);
  ...
  Future<void> _saveCorrectionNote() async {
    await ArchiveInsightFeedbackStore.ensureLoaded();
    final saved = await ArchiveInsightFeedbackStore.saveCorrectionNote(
      widget.insightId,
      _correctionController.text,
    );
    if (!saved) return;
  ...
  Future<void> _hide() async {
    await ArchiveInsightFeedbackStore.ensureLoaded();
    await ArchiveInsightFeedbackStore.hide(widget.insightId);
