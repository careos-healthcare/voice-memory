...
import 'package:archiveme_mobile/widgets/archive_packs/cross_pack_confirmation_card.dart';
import 'package:archiveme_mobile/widgets/memory/cross_thread_confirmation_card.dart';
import 'package:archiveme_mobile/widgets/memory/memory_authority_frame_card.dart';
import 'package:archiveme_mobile/widgets/memory/memory_connection_actions_row.dart';
import 'package:archiveme_mobile/widgets/memory/memory_governance_notice.dart';
import 'package:archiveme_mobile/widgets/memory/memory_priority_badge.dart';
import 'package:archiveme_mobile/widgets/memory/memory_reliability_badge.dart';
import 'package:archiveme_mobile/widgets/memory/memory_used_receipt.dart';
    ...
    if (!governance.allowsMemoryClaim || !priority.canSupportClaim) {
      if (governance.showBackgroundOnly || priority.backgroundOnly) {
        return Column(
          ...
          children: [
            const MemoryGovernanceNotice(backgroundOnly: true),
