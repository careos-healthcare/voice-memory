      ...
      children: [
        ...
        Align(
          ...
          child: TextButton(
            ...
            child: const Text(ReturnRitualCopy.clearButton),
          ),
        ),
        Text(
          ReturnRitualCopy.privacyLine,
...
class _OptionButton extends StatelessWidget {
  const _OptionButton({required this.label, required this.onTap, super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          FilledButton(
            ...
            child: const Text(ReturnRitualCopy.customPhraseSave),
          ),
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
            child: const Text(ReturnRitualCopy.customPhraseCancel),
          ),
        ],
      ),
    );
