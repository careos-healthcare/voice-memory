...
import 'package:archiveme_mobile/features/archive_agreement/archive_agreement_copy.dart';
...
class ArchiveTheoryAgreementSection extends StatefulWidget {
  const ArchiveTheoryAgreementSection({required this.theory, super.key});
