...
void main() {
  ...
  testWidgets('open moment shows saved moment detail', (tester) async {
    await _pump(tester, [
      _moment(
        'km_test_1',
        DateTime.now(),
        title: 'Open me',
        text: 'Full moment text',
        resultHint: 'lighter',
        tags: const ['helped'],
      ),
    ]);
    ...
    expect(find.text('Open me'), findsWidgets);
    expect(find.text('Full moment text'), findsWidgets);
  });
