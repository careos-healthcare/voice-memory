...
import 'package:archiveme_mobile/features/archive_proof/archive_paid_value_proof_source.dart';
import 'package:archiveme_mobile/features/archive_proof/proof_surface_advice_guard.dart';
import 'package:archiveme_mobile/features/patterns/patterns_stack_policy.dart';
...
void main() {
  ...
  group('Pattern screen back navigation', () {
    ArchiveBeliefCardModel detailBelief() => const ArchiveBeliefCardModel(
      id: 'belief-test',
