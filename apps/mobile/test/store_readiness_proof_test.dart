...
import 'package:archiveme_mobile/features/store_readiness_proof/store_readiness_proof_copy.dart';
...
void main() {
  ...
  group('StoreReadinessProofCopy', () {
    ...
    test(
      ...
      () {
        const line = StoreReadinessProofCopy.metadataLine;
  ...
  group('Protected areas', () {
    ...
    test('existing store readiness modules behaviour unchanged', () {
      const checklist = ProductionCandidateChecklist(
