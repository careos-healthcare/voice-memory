...
void main() {
  group('generated file guard', () {
    test('gitignore ignores test journal/prefs patterns', () {
      ...
      expect(gitignore, contains('apps/mobile/*_journal.json'));
      expect(gitignore, contains('apps/mobile/*_prefs.json'));
      expect(gitignore, contains('apps/mobile/_journal.json'));
      expect(gitignore, contains('apps/mobile/_prefs.json'));
    });
  ...
  group('first two-session copy', () {
    test('0-entry archive home mentions sample archive calmly', () {
      ...
      expect(summary.body.toLowerCase(), contains('archiveme'));
    ...
    test('1-entry next action explains why second moment matters', () {
      ...
      expect(summary.body.toLowerCase(), contains('compare what repeats'));
      expect(
