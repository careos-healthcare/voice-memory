...
import 'package:archiveme_mobile/widgets/patterns/patterns_thought_map_preview_card.dart';
...
void main() {
  ...
  group('ArchiveThoughtMapEngine', () {
    ...
    test('builds preview with nodes and connectors when evidence exists', () {
    ...
    test('uses persisted renamed title over generated title', () {
      final preview = _preview();
  ...
  group('PatternsThoughtMapPreviewCard', () {
    ...
    testWidgets('node with no snippets shows cautious fallback', (
      ...
      final base = _preview();
      const emptyNode = ArchiveThoughtMapNode(
