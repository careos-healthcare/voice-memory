...
const _consumerFacingSources = [
  ...
  'lib/features/beta_outcomes/beta_outcomes_copy.dart',
  'lib/features/beta_invite/beta_invite_copy.dart',
  'lib/features/pro_interest/pro_interest_copy.dart',
...
bool _allowlistedLine(String path, String line) {
  ...
  if (line.contains('archiveme.app')) return true;
  ...
  if (path.endsWith('privacy_copy_policy.dart')) {
    final trimmed = line.trim();
    if (trimmed.startsWith("'") &&
        (trimmed.endsWith("',") || trimmed.endsWith("'"))) {
      return true;
    }
    if (trimmed.startsWith('RegExp(')) return true;
  }
  return false;
}
