...
import 'package:archiveme_mobile/features/beta_activation/beta_activation_summary_store.dart';
...
void main() {
  ...
  Future<void> seedArchive() async {
    ...
    await PatternNameStore.setCustomName('said_yes', 'My pattern');
  ...
  group('Privacy centre backup controls', () {
    ...
    testWidgets('restore confirmation blocks replace until confirmed', (
      ...
      var beforeCancelRestore = const <JournalEntry>[];
      await tester.runAsync(() async {
