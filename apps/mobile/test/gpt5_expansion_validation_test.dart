...
Map<String, dynamic> _score(dynamic v1, Map<String, dynamic> pack) {
  ...
  var trustDet = 55;
  if (belief != null && belief.evidenceCount >= 5) trustDet += 15;
  ...
  var payDet = 35;
  if (belief != null && belief.confidencePercent >= 60) payDet += 15;
  if (v1.eligibleEntries.length >= 100) payDet += 10;

  var shareDet = 30;
  if (belief != null && belief.statement.length > 40) shareDet += 12;

  final packRich =
      pack['primaryBelief'] != null &&
