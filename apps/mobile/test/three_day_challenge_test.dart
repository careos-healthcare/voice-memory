...
import 'package:archiveme_mobile/features/first_proof_payoff/first_proof_payoff_gates.dart';
import 'package:archiveme_mobile/features/three_day_challenge/three_day_challenge_copy.dart';
import 'package:archiveme_mobile/features/three_day_challenge/three_day_challenge_engine.dart';
...
import 'package:archiveme_mobile/widgets/record/three_day_challenge_card.dart';
...
void main() {
  ...
  group('ThreeDayChallenge copy guard', () {
    test('no fake proof or medical therapy claims', () {
      ...
      expect(blob, contains('see what appeared and returned'));
      expect(blob, contains('come back when it repeats'));
      expect(blob, contains('no daily journal'));
    });
  });
