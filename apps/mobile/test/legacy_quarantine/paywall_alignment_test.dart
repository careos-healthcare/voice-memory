...
void main() {
  group('PaywallAlignmentCopy', () {
    ...
    test('defines trail benefit bullets', () {
      ...
      expect(
        ...
        contains('Longer evidence history on this device'),
      );
      expect(
        PaywallAlignmentCopy.benefitBullets,
      ...
      expect(
        PaywallAlignmentCopy.benefitBullets,
        contains('Continuity when patterns return or change'),
      );
    });
  });
  ...
  group('Protected billing areas', () {
    ...
    test('paywall purchase wiring unchanged', () {
      ...
      expect(paywallSource, contains('ArchivePaywallCopy.checkingProAccess'));
      expect(checkoutSource, contains('ArchivePaywallCopy.purchaseStarting'));
      expect(paywallSource, contains('RestorePurchasesFlow'));
      expect(paywallSource, contains('Future<void> _restore()'));
    });
