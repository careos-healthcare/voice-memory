...
const _bannedPatterns = <String, String>{
  ...
  'Cloud sync unavailable': 'Cloud sync unavailable',
  'Cloud analysis pending': 'Cloud analysis pending',
...
const _consumerCopyFiles = [
  ...
  '../../packages/archiveme_research/lib/screens/subscription_review_preview.dart',
  ...
  '../../packages/archiveme_research/lib/screens/key_moments_screen.dart',
  '../../packages/archiveme_research/lib/screens/key_moment_detail_screen.dart',
  'lib/features/ask_archive/ask_archive_screen.dart',
  'lib/widgets/patterns/archive_clean_view_card.dart',
  'lib/widgets/patterns/pattern_profile_card.dart',
  '../../packages/archiveme_research/lib/screens/pattern_profile_screen.dart',
  ...
  '../../packages/archiveme_research/lib/screens/pattern_map_screen.dart',
  ...
  '../../packages/archiveme_research/lib/screens/archive_evolution_timeline_screen.dart',
  ...
  '../../packages/archiveme_research/lib/screens/archive_compression_screen.dart',
...
void main() {
  ...
  for (final path in _consumerCopyFiles) {
    ...
    test('$path has no banned consumer jargon in string literals', () {
      final source = resolveRepoScanFile(path).readAsStringSync();
...
bool _archiveAllowed(String value) {
  ...
  if (lower.contains('private archive')) return true;
  if (lower.contains('longer archive')) return true;
  if (lower.contains('search archive')) return true;
