...
import 'package:archiveme_mobile/features/v1_interface/v1_expansion_gate_copy.dart';
import 'package:archiveme_mobile/features/v1_interface/v1_scope_guard_copy.dart';
...
void main() {
  ...
  group('Navigation simplicity', () {
    test('primary bottom nav exposes three direct V1 destinations', () {
    ...
    test('router shell has exactly three primary branches', () {
