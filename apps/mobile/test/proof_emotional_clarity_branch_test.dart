...
BetaTesterOutcome _proofClarityOutcome() => const BetaTesterOutcome(
  testerId: 'proof',
  signals: {
...
ProofConfidenceCalibrationResult _watchCalibration({required int entryCount}) =>
    ProofConfidenceCalibrationResult(
      ...
      primaryCopy: 'Thoughtprint is watching this for now.',
      displayCopy: 'Thoughtprint is watching this for now.',
      hasSafeAnchor: false,
