...
import 'package:archiveme_mobile/features/curiosity_loop/infrastructure/stores/local_cognitive_baseline_store.dart';
...
void main() {
  group('Encrypted Stores Extended Tests', () {
    ...
    setUp(() async {
      ...
      secureCryptoStorage = EncryptedJsonStorage(
        masterKeyBytes: List<int>.generate(32, (i) => i),
      );
    ...
    test(
      'Baseline store migrates legacy prefs key to secure key on read',
      () async {
