...
final _forbiddenLoopPatterns = [
  RegExp('showed up again.*showed up again', caseSensitive: false),
  RegExp('come back when.*come back when', caseSensitive: false),
  RegExp('what got in the way.*what got in the way', caseSensitive: false),
  RegExp('what felt different.*what felt different', caseSensitive: false),
];
