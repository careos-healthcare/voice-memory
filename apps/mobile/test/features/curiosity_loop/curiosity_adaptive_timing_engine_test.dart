import 'package:archiveme_mobile/features/curiosity_loop/services/curiosity_adaptive_timing_engine.dart';
...
void main() {
  ...
  group('CuriosityAdaptiveTimingEngine', () {
    ...
    test('uses only the last five entries when history is longer', () {
      final currentEntryTime = DateTime(2026, 6, 12, 20);
      final history = [
    ...
    test('supports fractional average hours with minute rounding', () {
      final currentEntryTime = DateTime(2026, 6, 12, 9);
      final history = [
        _entry(id: 'e1', createdAt: DateTime(2026, 6, 10, 8)),
        _entry(id: 'e2', createdAt: DateTime(2026, 6, 11, 8, 30)),
        _entry(id: 'e3', createdAt: DateTime(2026, 6, 12, 9)),
      ];
