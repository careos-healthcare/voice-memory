...
void main() {
  ...
  group('JournalEntryBacklinkService', () {
    test(
      'builds quote highlights from fact ledger values in transcript',
      () async {
    ...
    test(
      'getDerivedInsights returns empty when archive lacks minimum evidence',
      () async {
        final journalStore = await JournalStore.open(
          '${tempDir.path}/solo.json',
        );
        await journalStore.save(
          _entry(
            id: 'solo_entry',
