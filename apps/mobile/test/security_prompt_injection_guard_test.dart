...
void main() {
  ...
  group('AiPromptBoundary', () {
    ...
    test('log summary avoids full private text', () {
      ...
      final fields = AiPromptBoundary.logFields(prepared);
      expect(fields.containsKey('user_text_length_bucket'), isTrue);
      expect(fields.containsKey('prompt_injection'), isTrue);
      expect(fields.toString(), isNot(contains('family conflict')));
      expect(fields.toString(), isNot(contains('hash')));
    });
  });
