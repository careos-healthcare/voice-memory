...
import 'package:archiveme_mobile/features/beta_proof_lift/beta_proof_lift_engine.dart';
...
import 'package:archiveme_mobile/features/proof_caution_guard/proof_caution_guard_analytics.dart';
import 'package:archiveme_mobile/features/proof_caution_guard/proof_caution_guard_copy.dart';
import 'package:archiveme_mobile/features/proof_caution_guard/proof_caution_guard_engine.dart';
...
void main() {
  ...
  tearDown(ProofCautionGuardAnalytics.resetForTest);
  ...
  group('ProofCautionGuardEngine upgrades', () {
    ...
    test(
      ...
      () {
        const calibration = ProofConfidenceCalibrationResult(
          shouldCalibrate: true,
          entryCount: 4,
          source: 'test',
        ...
        const matchQuality = PatternMatchQualityResult(
          shouldResolve: true,
          entryCount: 4,
          source: 'test',
          score: 50,
