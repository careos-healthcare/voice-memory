...
import 'package:archiveme_mobile/features/proof_specificity_boost/proof_specificity_boost_analytics.dart';
import 'package:archiveme_mobile/features/proof_specificity_boost/proof_specificity_boost_copy.dart';
import 'package:archiveme_mobile/features/proof_specificity_boost/proof_specificity_boost_engine.dart';
...
import 'package:archiveme_mobile/widgets/patterns/proof_specificity_boost_card.dart';
...
void main() {
  ...
  tearDown(ProofSpecificityBoostAnalytics.resetForTest);
  ...
  group('ProofSpecificityBoostCard', () {
    ...
    testWidgets('renders safe fallback when no safe anchors', (tester) async {
      const result = ProofSpecificityBoostResult(
        shouldShow: true,
        entryCount: 3,
        source: 'test',
