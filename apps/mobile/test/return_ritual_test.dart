...
import 'package:archiveme_mobile/features/return_ritual/return_ritual_gates.dart';
...
import 'package:archiveme_mobile/widgets/return_ritual_card.dart';
...
void main() {
  ...
  group('Return ritual store', () {
    ...
    test('persists custom phrase locally', () async {
      const choice = ReturnRitualChoice(
