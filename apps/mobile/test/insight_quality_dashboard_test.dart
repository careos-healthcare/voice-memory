...
void main() {
  ...
  group('InsightQualityDashboardEngine', () {
    ...
    test('summary counts correction notes', () async {
  ...
  group('InsightQualityScreen', () {
    test('correction note entries expose local preview text', () async {
    ...
    test('delete correction note clears dashboard summary', () async {
      ...
      await ArchiveInsightFeedbackStore.deleteCorrectionNote(id);
    ...
    test('correction notes do not appear in share-safe proof', () async {
      await ArchiveInsightFeedbackStore.saveCorrectionNote(
  ...
  group('Routing and access', () {
    ...
    testWidgets('Settings exposes insight quality link', (tester) async {
      if (!V1FeatureFlags.enableCustomReports) {
        // Focused beta hides custom reports / insight quality in settings.
        return;
      }
