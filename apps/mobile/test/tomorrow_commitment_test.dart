...
import 'package:archiveme_mobile/widgets/patterns/tomorrow_return_status_card.dart';
import 'package:archiveme_mobile/widgets/record/tomorrow_commitment_card.dart';
...
void main() {
  ...
  test('markCompleteIfTargetDay sets completedAt on target day', () async {
    ...
    final targetDay = DateTime(2026, 7);
