...
import 'package:archiveme_mobile/features/proof_quality_response/proof_quality_response_analytics.dart';
...
import 'package:archiveme_mobile/features/proof_quality_response/proof_quality_response_store.dart';
...
import 'package:archiveme_mobile/widgets/patterns/proof_quality_response_card.dart';
...
void main() {
  ...
  group('ProofQualityResponseEngine too vague', () {
    ...
    test('uses fallback copy when no safe anchors resolved', () {
      const result = ProofQualityResponseResult(
        shouldShow: true,
