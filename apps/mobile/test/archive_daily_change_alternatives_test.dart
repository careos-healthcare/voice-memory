import 'package:archiveme_mobile/features/archive_daily_change/archive_daily_change_copy.dart';
    ...
    testWidgets('shows sharpened label and body', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const Scaffold(body: ArchiveDailyChangeCard(result: result)),
        ),
      );
