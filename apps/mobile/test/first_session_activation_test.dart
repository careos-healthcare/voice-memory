...
import 'package:archiveme_mobile/features/referral/invited_day_two_return.dart';
...
import 'package:archiveme_mobile/widgets/referral/invited_day_two_return_card.dart';
import 'package:archiveme_mobile/widgets/referral/invited_user_welcome_card.dart';
...
void main() {
  ...
  group('Pressure insights activation copy', () {
    ...
    testWidgets('early-signal nudge appears for one entry', (tester) async {
      await _pumpInsights(tester, records: [_record()]);
