...
import 'package:archiveme_mobile/features/beta_activation_path/beta_activation_path_analytics.dart';
import 'package:archiveme_mobile/features/beta_activation_path/beta_activation_path_copy.dart';
...
import 'package:archiveme_mobile/features/beta_activation_path/beta_activation_path_store.dart';
...
void main() {
  ...
  group('BetaActivationPathEngine stages', () {
    test('0 entries shows first-save stage', () {
      final result = _buildResult(context: _context());
  ...
  group('BetaActivationPathCard', () {
    testWidgets('primary CTA invokes handler', (tester) async {
      ...
      await _pumpCard(
        tester,
        result: _buildResult(context: _context()),
