...
import 'package:archiveme_mobile/widgets/daily_archive_exercise_card.dart';
import 'package:archiveme_mobile/widgets/record/daily_archive_exercise_record_card.dart';
...
const List<String> _recordBannedWords = [
  ..._bannedWords,
  'exercise',
  'challenge',
  'coach',
...
void main() {
  ...
  group('Record screen card', () {
    testWidgets('Record prompt works when enabled', (tester) async {
      final exercise = engine.build(_input());
      var tapped = false;
