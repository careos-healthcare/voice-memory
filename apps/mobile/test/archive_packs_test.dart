...
import 'package:archiveme_mobile/features/archive_packs/archive_pack_markdown_import.dart';
...
import 'package:archiveme_mobile/widgets/memory/entry_options_section.dart';
  ...
  group('UI', () {
    ...
    testWidgets('zero-entry first impression keeps pack picker collapsed', (
      ...
      await tester.pumpWidget(
        MaterialApp(
          theme: AppTheme.light(),
          home: const Scaffold(body: EntryOptionsSection()),
        ),
      );
