...
import 'package:archiveme_mobile/features/moment_quality/post_save_moment_detail_analytics.dart';
import 'package:archiveme_mobile/features/moment_quality/post_save_moment_detail_copy.dart';
...
import 'package:archiveme_mobile/widgets/record/post_save_moment_detail_sheet.dart';
...
JournalEntry _parentEntry({
  String id = 'parent1',
  String transcript = _mediumText,
}) => JournalEntry(
  id: id,
...
void main() {
  ...
  group('PostSaveMomentDetailCopy', () {
    test('each detail type has correct prompt and helper', () {
      expect(
        PostSaveMomentDetailCopy.promptTitle(
          PostSaveMomentDetailType.situation,
        ),
        'What was the situation?',
      );
      expect(
        PostSaveMomentDetailCopy.promptHelper(
          PostSaveMomentDetailType.situation,
        ),
  ...
  group('CapturePipelineService.savePostSaveMomentDetail', () {
    ...
    test(
      'updates existing linked detail instead of creating duplicate',
      () async {
        final parent = _parentEntry();
        await journal.save(parent);
  ...
  group('PostSaveMomentDetailSheet', () {
    ...
    testWidgets('save failure preserves draft and shows retry copy', (
      ...
      expect(
        find.text(PostSaveMomentDetailCopy.saveFailedMessage),
        findsOneWidget,
      );
  ...
  group('SavedMomentQualityCard taps', () {
    ...
    testWidgets('Add what made it stand out opens detail sheet', (
      tester,
    ) async {
      PostSaveMomentDetailType? opened;
  ...
  group('PostSaveMomentDetailAnalytics', () {
    test('event names and fields exclude user content keys', () {
      ...
      expect(
        PostSaveMomentDetailAnalytics.savedEvent,
