...
import 'package:archiveme_mobile/features/retention/return_tomorrow_cue_model.dart';
import 'package:archiveme_mobile/models/journal_entry.dart';
import 'package:archiveme_mobile/models/reflection.dart';
import 'package:archiveme_mobile/product/consumer_ui_copy.dart';
import 'package:archiveme_mobile/services/capture_save_messages.dart';
import 'package:archiveme_mobile/widgets/record/return_tomorrow_cue_card.dart';
...
void main() {
  ...
  group('ReturnTomorrowCueEngine evidence gates', () {
    ...
    test('pending transcript entries do not show cue', () {
      final entries = [_voiceEntry(id: 'p')];
      expect(
        ReturnTomorrowCueEngine.buildPostSave(
          entries: entries,
          firstProofUnlocked: false,
