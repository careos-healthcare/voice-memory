...
import 'package:archiveme_mobile/features/early_archive/early_repeat_progress_gates.dart';
import 'package:archiveme_mobile/features/early_archive/early_repeat_progress_model.dart';
import 'package:archiveme_mobile/features/early_archive/early_saved_moments_analytics.dart';
...
import 'package:archiveme_mobile/features/early_archive/early_saved_moments_gates.dart';
...
import 'package:archiveme_mobile/features/early_archive/post_save_return_handoff_gates.dart';
...
import 'package:archiveme_mobile/widgets/record/early_repeat_progress_card.dart';
import 'package:archiveme_mobile/widgets/record/early_saved_moments_sheet.dart';
import 'package:archiveme_mobile/widgets/record/first_proof_moment_card.dart';
import 'package:archiveme_mobile/widgets/record/post_save_return_handoff_card.dart';
...
void main() {
  group('EarlyRepeatProgressEngine', () {
    ...
    test('entryCount 2 related uses shared phrase in next moment cue', () {
      ...
      final phrase = shared!;
      expect(result!.nextMomentCue.body, contains(phrase));
      expect(
        result.nextMomentCue.body,
    ...
    test('next moment cue does not dump full transcript', () {
      ...
      final quoted = RegExp('“([^”]+)”').firstMatch(result.nextMomentCue.body);
      if (quoted != null) {
