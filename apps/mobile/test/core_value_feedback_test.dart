...
import 'package:archiveme_mobile/features/beta/core_value_feedback_gates.dart';
...
import 'package:archiveme_mobile/widgets/beta/core_value_feedback_card.dart';
        ...
        const MaterialApp(
          home: Scaffold(
            body: CoreValueFeedbackCard.test(
              ...
              hasConfirmedRepeat: true,
              hasFirstProof: true,
              initialRecord: CoreValueFeedbackRecord(
                answer: CoreValueFeedbackAnswer.yes,
              ),
            ),
          ),
