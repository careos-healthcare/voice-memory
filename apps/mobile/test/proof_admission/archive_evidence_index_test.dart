...
void main() {
  ...
  group('related sources', () {
    ...
    test('the earlier moment wins an equal overlap', () {
      ...
      index.upsertEntry(
        entry('later', shared, createdAt: DateTime(2026, 3)),
      );
      index.upsertEntry(
        entry('earlier', shared, createdAt: DateTime(2026, 2)),
      );
  ...
  group('occurrences', () {
    test('counts distinct moments, not citations', () {
      final index = freshIndex();
      index.upsertEntry(
        entry('a', 'phone at dinner', createdAt: DateTime(2026)),
      );
      index.upsertEntry(
        entry('b', 'phone at dinner', createdAt: DateTime(2026, 2)),
      );
      ...
      expect(occurrences.firstOccurrence, DateTime(2026));
      expect(occurrences.latestOccurrence, DateTime(2026, 2));
    });
    ...
    test('a window counts only what is logged inside it', () {
      ...
      index.upsertEntry(
        entry('old', 'phone at dinner', createdAt: DateTime(2025, 6)),
      );
      index.recordFraming(
        framing: 'framing_1',
        claimKind: 'repeated',
