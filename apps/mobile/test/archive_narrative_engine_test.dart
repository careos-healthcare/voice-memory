import 'package:archiveme_mobile/features/archive_narrative/archive_narrative_engine.dart';
import 'package:archiveme_mobile/features/archive_narrative/narrative_summary_models.dart';
      ...
      blocks: [
        BeliefEvolutionBlock(
          version: BeliefVersionRecord(
            ...
            confidence: 60,
            recordedAt: DateTime.utc(2024).toIso8601String(),
