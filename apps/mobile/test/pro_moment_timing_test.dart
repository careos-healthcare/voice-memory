...
import 'package:archiveme_mobile/features/pro_moment_timing/pro_moment_timing_copy.dart';
import 'package:archiveme_mobile/features/pro_moment_timing/pro_moment_timing_engine.dart';
...
void main() {
  ...
  group('ProMomentTimingEngine blocked moments', () {
    ...
    test('blocks before first proof', () {
      final result = ProMomentTimingEngine.evaluate(
        _baseContext(hasFirstProof: false),
      );
      expect(result.allowed, isFalse);
      expect(
        result.blockedReason,
