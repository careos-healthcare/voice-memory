...
import 'package:archiveme_mobile/features/proof_relevance_repair/proof_relevance_outcome_copy.dart';
import 'package:archiveme_mobile/features/proof_relevance_repair/proof_relevance_outcome_matrix.dart';
...
void main() {
  ...
  group('ProofRelevanceOutcomeMatrix.resolve', () {
    ...
    test('low understoodWhatItNoticed returns proofNotUnderstood', () {
      expect(
        ProofRelevanceOutcomeMatrix.resolve(
          _summary(understoodWhatItNoticedCount: 5),
        ),
    ...
    test('low couldTellIfRight returns proofNotUnderstood', () {
      expect(
        ProofRelevanceOutcomeMatrix.resolve(
          _summary(couldTellIfRightCount: 5),
        ),
        ProofRelevanceOutcomeDecision.proofNotUnderstood,
      );
    });
