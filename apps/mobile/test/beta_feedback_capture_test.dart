...
import 'package:archiveme_mobile/features/beta_feedback_capture/beta_feedback_capture_analytics.dart';
...
void main() {
  ...
  group('BetaFeedbackCaptureEngine', () {
    ...
    test('respects surface priority via core capture CTA guard', () {
      final result = BetaFeedbackCaptureEngine.build(
        context: _context(coreCaptureCtaVisible: true),
      );
      expect(result.shouldShow, isFalse);
    });
    ...
    test('hidden during recording', () {
      final result = BetaFeedbackCaptureEngine.build(
        context: _context(isRecording: true),
      );
      expect(result.shouldShow, isFalse);
    });
    ...
    test('hidden during degraded transcript', () {
      final result = BetaFeedbackCaptureEngine.build(
        context: _context(isDegradedTranscriptState: true),
      );
      expect(result.shouldShow, isFalse);
    });
    ...
    test('hidden during WhatChanged', () {
      final result = BetaFeedbackCaptureEngine.build(
        context: _context(whatChangedQuestionActive: true),
      );
      expect(result.shouldShow, isFalse);
    });
