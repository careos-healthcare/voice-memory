...
abstract final class V1MomentSaveReceiptExpectations {
  ...
  static final Finder title =
      find.byKey(const Key('moment_save_receipt_title'));
  static final Finder transcript =
      find.byKey(const Key('moment_save_receipt_transcript'));
  static final Finder recordAnother =
      find.byKey(const Key('moment_save_receipt_record_another'));
  static final Finder viewArchive =
      find.byKey(const Key('moment_save_receipt_view_archive'));
  static final Finder degradedBody =
      find.byKey(const Key('moment_save_receipt_degraded_body'));
  static final Finder typeWhatYouSaid =
