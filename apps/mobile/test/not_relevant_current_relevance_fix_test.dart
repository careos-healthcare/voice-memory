...
import 'package:archiveme_mobile/features/not_relevant_recovery/not_relevant_recovery_analytics.dart';
...
import 'package:archiveme_mobile/features/not_relevant_recovery/not_relevant_recovery_store.dart';
...
import 'package:archiveme_mobile/widgets/patterns/not_relevant_recovery_card.dart';
...
void main() {
  ...
  group('NotRelevantRecoveryEngine triggers', () {
    ...
    test('hidden during recording', () {
      const result = NotRelevantRecoveryResult(
        shouldShow: true,
        proofKey: '1|2|3',
        entryCount: 3,
        source: 'test',
