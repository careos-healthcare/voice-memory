...
import 'package:archiveme_mobile/features/next_evidence_plan/next_evidence_plan_copy.dart';
import 'package:archiveme_mobile/features/next_evidence_plan/next_evidence_plan_engine.dart';
import 'package:archiveme_mobile/features/next_evidence_plan/next_evidence_plan_gates.dart';
...
import 'package:archiveme_mobile/widgets/next_evidence_plan_card.dart';
...
void main() {
  ...
  group('Next evidence plan privacy boundaries', () {
    ...
    test('focused beta archive home excludes next evidence plan card', () {
      final src = File(
        'lib/features/archive/screens/archive_belief_screen.dart',
      ).readAsStringSync();
      expect(src, isNot(contains('NextEvidencePlanCard')));
      expect(src, isNot(contains('NextEvidencePlanGates')));
    });
  });
}