...
import 'package:archiveme_mobile/widgets/onboarding/first_60_second_intro_card.dart';
import 'package:archiveme_mobile/widgets/onboarding/first_archive_value_card.dart';
import 'package:archiveme_mobile/widgets/onboarding/first_recording_value_card.dart';
import 'package:archiveme_mobile/widgets/onboarding/pro_continuity_bridge_card.dart';
import 'package:archiveme_mobile/widgets/onboarding/tomorrow_return_card.dart';
...
void main() {
  ...
  group('Store persistence', () {
    ...
    test('no persistence resolves everything so nothing can nag', () async {
      final store = First60SecondStore();
