...
import 'package:archiveme_mobile/widgets/signal/signal_journey_card.dart';
import 'package:archiveme_mobile/widgets/signal/signal_journey_completion_card.dart';
...
void main() {
  ...
  testWidgets('empty journey detail state', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: SignalJourneyScreen()),
    );
    await tester.pump();
