...
import 'package:archiveme_mobile/features/early_archive/daily_return_reason_analytics.dart';
...
import 'package:archiveme_mobile/features/early_archive/daily_return_reason_gates.dart';
...
import 'package:archiveme_mobile/widgets/record/daily_return_reason_card.dart';
...
void main() {
  ...
  group('DailyReturnReasonEngine', () {
    ...
    test(
      'no positive pattern chooses helped prompt when loop and change known',
      () {
        final reason = DailyReturnReasonEngine.build(
          entries: _threeRelatedRepeatEntries(),
