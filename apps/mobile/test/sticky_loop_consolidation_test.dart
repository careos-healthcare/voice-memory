...
import 'package:archiveme_mobile/features/todays_question/todays_question_engine.dart';
...
ArchiveHomePriorityInput _priorityInput({
  ...
  bool capacityBoundaryResponseVisible = false,
...
void main() {
  ...
  group('Archive Home sticky loop priority', () {
    test('0 entries: first-week path primary, mature cards hidden', () {
      final plan = priorityEngine.build(_priorityInput());
      expect(
