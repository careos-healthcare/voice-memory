...
import 'package:archiveme_mobile/features/retention/return_day_journey_engine.dart';
...
SignalJourney _journey({DateTime? started}) {
  return SignalJourney(
    ...
    startedAt: started ?? DateTime(2026, 6),
...
void main() {
  test('return-day card appears with active journey on next day', () {
    ...
    final decision = engine.evaluate(
      journey: _journey(started: DateTime(2026, 6)),
      reflectionCount: 2,
