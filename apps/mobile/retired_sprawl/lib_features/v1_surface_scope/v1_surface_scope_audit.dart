...
abstract final class V1SurfaceScopeAudit {
  ...
  static const List<V1VisibleSurface> coreSurfaces = [
  ...
  static const List<V1VisibleSurface> secondarySurfaces = [
  ...
  static const List<V1VisibleSurface> releaseBlockerSurfaces = [
