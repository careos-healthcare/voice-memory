...
class RecordLivePcm16CaptureSource implements LivePcm16CaptureSource {
  ...
  final bool configureIosAudioSession;
  ...
  void dispose() {
    unawaited(stop());
    final activeRecorder = _activeRecorder;
    if (activeRecorder != null) unawaited(activeRecorder.dispose());
  ...
  Future<void> _ensureMicrophonePermission() async {
    ...
    if (requested.isGranted || await recorder.hasPermission()) {
      return;
    }
