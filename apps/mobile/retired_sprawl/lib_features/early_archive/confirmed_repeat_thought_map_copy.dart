/// Copy for the post-proof Thought Map card — loop mapping, not diagnosis.
abstract final class ConfirmedRepeatThoughtMapCopy {
  ...
  static const thoughtUnknown =
      'Record what your mind was saying in the moment.';

  static const actionLabel = 'Action';
  static const actionQuestion = 'What did you do next?';
  static const actionUnknown = 'Record what you did when it showed up.';

  static const resultLabel = 'Result';
  static const resultQuestion = 'Did it help, cost you, or change?';
  static const resultUnknown =
      'Record whether it helped, cost you, or felt different.';
