...
abstract final class ReturnCheckPayoffCopy {
  ...
  static const strongerFooter =
      'Thoughtprint is watching whether this changes when it comes back.';

  static const sameTitle = 'This looked about the same';
  static const sameBodyFallback =
      'This return still connects to your first repeat. Thoughtprint has not seen a clear shift yet.';
  ...
  static const changedFooter =
      'Thoughtprint tracks what happens when this comes back.';

  static const unknownTitle = 'Thoughtprint added this return';
  static const unknownBody =
      'This moment joins your evidence trail. Thoughtprint needs more returns before it can compare stronger, softer, or about the same since your first proof.';
