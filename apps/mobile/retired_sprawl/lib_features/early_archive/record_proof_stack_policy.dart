...
abstract final class RecordProofStackPolicy {
  ...
  static RecordProofStackDecision decide({
    ...
    final showPatternChanged = patternChangedVisible;
    final showHelpfulActionAppeared = helpfulActionAppearedEligible;
    final showPositiveReinforcement =
        positiveReinforcementEligible && !showHelpfulActionAppeared;
    final showArchiveCurrentBelief = archiveCurrentBeliefEligible;
