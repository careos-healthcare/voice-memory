...
class FirstSessionPatternEngine {
  ...
  FirstSessionPattern _assemble({
    ...
    final ambiguityMargin = topScore == 0
        ? 0.0
        : (gap / topScore).clamp(0.0, 1.0);

    var lowConfidence = scoreResult.lowConfidence;
    final closeScores = scoreResult.closeScores;
  ...
  _definitions = {
    FirstSessionPatternCategory.responsibility: const _PatternDefinition(
      ...
      chips: ['saying yes fast', 'carrying it alone', 'asking late'],
      phrases: [
        'saying yes',
        'have to',
        'let down',
    ...
    FirstSessionPatternCategory.worry: const _PatternDefinition(
      ...
      chips: ['same worry', 'overthinking', 'hard to switch off'],
      phrases: [
        'cannot switch off',
        'can not switch off',
    ...
    FirstSessionPatternCategory.relationship: const _PatternDefinition(
      ...
      chips: ['same person', 'unsaid tension', 'replaying it'],
      phrases: [],
      keywords: [
        'family',
        'friend',
    ...
    FirstSessionPatternCategory.selfDoubt: const _PatternDefinition(
      ...
      chips: ['not enough', 'proving myself', 'feeling judged'],
      phrases: ['not good enough', 'doubt myself'],
      keywords: [
        'prove',
        'proving',
        'failure',
    ...
    FirstSessionPatternCategory.avoidance: const _PatternDefinition(
      ...
      chips: ['putting it off', 'hard to start', 'stuck'],
      phrases: [
        'put off',
        'hard to start',
        'cannot start',
    ...
    FirstSessionPatternCategory.burnout: const _PatternDefinition(
      ...
      chips: ['no energy', 'too much', 'feeling heavy'],
      phrases: ['burnt out', 'no energy'],
      keywords: [
        'tired',
        'exhausted',
        'drained',
    ...
    FirstSessionPatternCategory.fallback: const _PatternDefinition(
      ...
      chips: ['same feeling', 'same situation', 'same time of day'],
      phrases: [],
      keywords: [],
    ),
    FirstSessionPatternCategory.lighter: const _PatternDefinition(
      ...
      chips: ['felt lighter', 'calmer moment', 'easier today'],
      phrases: [],
      keywords: [],
    ),
  };
