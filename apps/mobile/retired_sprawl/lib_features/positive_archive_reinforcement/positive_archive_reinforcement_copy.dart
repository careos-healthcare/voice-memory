...
abstract final class PositiveArchiveReinforcementCopy {
  ...
  static const repeatRelatedLine =
      'This may help Thoughtprint see whether the repeat is returning, changing, '
      'fading, or getting corrected.';

  static const notEnoughProofLine =
      'No need to force more. Thoughtprint works from real moments over time.';
  ...
  static const repeatRelatedMomentSavedMessage =
      'Saved. This may help Thoughtprint see whether the repeat is returning, '
