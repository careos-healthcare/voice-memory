...
abstract final class FirstWeekProgressCopy {
  ...
  static const day1Body = 'Thoughtprint starts with one real moment.';
  ...
  static const firstProofBody = 'Thoughtprint can now compare what changes.';

  static String dayNTitle(int day) => 'Day $day of 7';
  static const day3to7Body =
      'Thoughtprint gets sharper when you return to the same pattern.';
