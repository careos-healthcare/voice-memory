...
import 'package:archiveme_mobile/features/widget_release_risk/widget_release_risk_gate.dart';
...
abstract final class ReleaseFragilityAudit {
  ...
  static const List<ReleaseFragilityRiskId> canonicalRiskOrder = [
  ...
  static ReleaseFragilityAuditInput fromRepoSignals({
    ...
    required String androidManifestSource,
    required String mainActivityKtSource,
    String extensionEntitlementsSource = '',
    String objectiveWidgetStorageSwiftSource = '',
    String todayCheckWidgetSwiftSource = '',
    ...
    final widgetInput = WidgetReleaseRiskGate.fromRepoSignals(
      ...
      androidManifest: androidManifestSource,
      mainActivityKt: mainActivityKtSource,
    ...
    return ReleaseFragilityAuditInput(
      ...
      widgetExtensionNeedsReview: V1CapabilityRegistry.nativeExtensions
          ? widgetResult.widgetShouldBeDisabled
          : false,
  ...
  static bool detectSupportUrlConfigured(String appConfigSource) =>
      appConfigSource.contains('https://archiveme.app/contact');

  static bool detectPrivacyUrlConfigured(String appConfigSource) =>
      appConfigSource.contains('https://archiveme.app/privacy');
...
class ReleaseFragilityAuditInput {
  const ReleaseFragilityAuditInput({
    required this.secretsRotationInput, this.signingConfigured,
