...
abstract class PostSaveRepeatCopy {
  ...
  static const genericBody = EvidenceEligibilityCopy.relatedMomentsBody;
  static const similarThemeBody = EvidenceEligibilityCopy.relatedMomentsTitle;
  ...
  static PostSaveRepeatDisplay resolve(
    DailyMirrorResult mirror, {
    int admittedMomentCount = 2,
  }) {
    if (admittedMomentCount < EvidenceEligibilityPolicy.relatedMomentsMinimum ||
        mirror.stage != DailyMirrorStage.possibleLoop ||
