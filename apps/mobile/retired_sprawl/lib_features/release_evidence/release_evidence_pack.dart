...
abstract final class ReleaseEvidencePack {
  ...
  static const List<ReleaseEvidenceItem> _billingEvidenceItems = [
  ...
  static const List<ReleaseEvidenceItem> _coreEvidenceItems = [
  ...
  /// Required for the current capability registry — billing items only when enabled.
  static List<ReleaseEvidenceItem> get requiredEvidenceItems => [
    ..._coreEvidenceItems,
    if (V1CapabilityRegistry.storeBilling) ..._billingEvidenceItems,
  ];
  ...
  static ReleaseEvidencePackResult resolve(ReleaseEvidencePackInput input) {
    ...
    if (!input.secretsRotated) {
      return const ReleaseEvidencePackResult(
