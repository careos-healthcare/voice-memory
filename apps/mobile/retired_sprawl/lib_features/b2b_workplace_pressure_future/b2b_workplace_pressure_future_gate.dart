...
abstract final class B2bWorkplacePressureFutureGate {
  ...
  static const List<B2bWorkplacePressureAudienceId> canonicalAudienceOrder = [
  ...
  static const List<B2bWorkplacePressureFuturePrereqId> canonicalPrereqOrder = [
    B2bWorkplacePressureFuturePrereqId.testFlightUploaded,
    B2bWorkplacePressureFuturePrereqId.paidIntentBetaComplete,
  ];

  static const List<B2bWorkplacePressureFutureRuleId> canonicalRuleOrder = [
  ...
  static const Map<B2bWorkplacePressureAudienceId, String> audienceWedgeIdByAudience = {
