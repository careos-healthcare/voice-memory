...
abstract class PrivacyScreenCopy {
  ...
  /// state), so this points at the live status this screen already shows
  /// instead of asserting a fixed one, and it names no storage engine — the
  /// search index lives outside the journal store.
  static const String privateByDefaultBody =
      '${PrivacyCopyPolicy.nothingSentUnlessFeatureChosen} Your moments stay '
      'in local databases on this device, and this screen reports how this '
      'build protects them, instead of asserting it here.';
