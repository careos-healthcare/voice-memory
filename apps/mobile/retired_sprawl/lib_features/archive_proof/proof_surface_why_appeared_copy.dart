...
abstract final class ProofSurfaceWhyAppearedCopy {
  ...
  static const evidenceTimeline =
      'Thoughtprint connected related evidence across your saved moments.';
