...
abstract final class LowEffortArchiveCaptureCopy {
  ...
  static const body =
      'Thoughtprint does not need constant chatting or daily journaling. Save one real '
  ...
  static const noMaintenanceLine =
      'You do not maintain the mind map. Thoughtprint builds the trail from saved moments.';
  ...
  static const chatDifferenceLine =
      'ChatGPT helps with the conversation you are having now. Thoughtprint keeps proof '
  ...
  static const guardrail =
      'Do not make Thoughtprint feel like a daily task, streak, homework, or manual '
