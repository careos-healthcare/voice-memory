...
/// Local dismiss state for three-moment completion — today only, no network.
class ThreeMomentCompletionStore {
  ThreeMomentCompletionStore(this._prefs);

  static const dismissPrefsKey = 'threeMomentCompletionDismiss_v1';
  ...
  static ThreeMomentCompletionStore instance() =>
      ThreeMomentCompletionStore(AppServices.instance.prefs);

  static ThreeMomentCompletionStore forPrefs(MobilePrefsStore prefs) =>
      ThreeMomentCompletionStore(prefs);
