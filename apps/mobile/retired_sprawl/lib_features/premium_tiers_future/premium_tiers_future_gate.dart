...
abstract final class PremiumTiersFutureGate {
  ...
  static const List<PremiumTierFutureId> canonicalTierOrder = [
  ...
  static const List<PremiumTiersFuturePrereqId> canonicalPrereqOrder = [
    PremiumTiersFuturePrereqId.simpleProPurchaseProofComplete,
  ];

  static const List<PremiumTiersFutureRuleId> canonicalRuleOrder = [
