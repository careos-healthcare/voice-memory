...
/// Local dismiss state for beta activation path — today only, no network.
abstract final class BetaActivationPathStore {
  BetaActivationPathStore._();

  static const dismissPrefsKey = 'betaActivationPathDismiss_v1';
