...
abstract final class BetaActivationPathEngine {
  ...
  static _StageCopy _copyFor(BetaActivationPathStage stage) => switch (stage) {
    BetaActivationPathStage.firstSave => const _StageCopy(
    ...
    BetaActivationPathStage.secondSave => const _StageCopy(
    ...
    BetaActivationPathStage.thirdSave => const _StageCopy(
    ...
    BetaActivationPathStage.proofCheck => const _StageCopy(
    ...
    BetaActivationPathStage.valueMoment => const _StageCopy(
    ...
    BetaActivationPathStage.proReview => const _StageCopy(
