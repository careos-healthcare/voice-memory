...
import 'package:archiveme_mobile/features/archive_calendar/archive_calendar_engine.dart';
...
import 'package:archiveme_mobile/features/first_week_path/first_week_path_engine.dart';
import 'package:archiveme_mobile/features/milestone_share/milestone_share_copy.dart';
import 'package:archiveme_mobile/features/milestone_share/milestone_share_gates.dart';
...
class MilestoneShareEngine {
  ...
  static const Map<MilestoneShareId, int> _milestoneRanks = {
  ...
  MilestoneShareResult build(MilestoneShareInput input) {
    ...
    if (cards.isEmpty) {
      return const MilestoneShareResult(
        cards: [],
        primaryCard: null,
