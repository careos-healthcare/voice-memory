...
abstract final class SafeExportsFutureGate {
  ...
  static const List<SafeExportFutureId> canonicalExportOrder = [
  ...
  static const List<SafeExportFuturePrereqId> canonicalPrereqOrder = [
    SafeExportFuturePrereqId.exportTestsPass,
    SafeExportFuturePrereqId.paidIntentBetaComplete,
  ];

  static const List<SafeExportsFutureRuleId> canonicalRuleOrder = [
