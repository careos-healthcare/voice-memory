...
import 'package:archiveme_mobile/features/archive_reactivity/archive_log_hygiene.dart';
...
abstract class PatternCopyQualityGate {
  ...
  static String? _phraseIssue(String phrase) {
    ...
    final last = words.last.replaceAll(RegExp('[^a-z]'), '');
