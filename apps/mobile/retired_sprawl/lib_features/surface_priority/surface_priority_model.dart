...
class SurfacePriorityCandidates {
  ...
  factory SurfacePriorityCandidates.recordReady({
    required bool firstMomentCapture, required bool secondMomentReturn, required bool lowFrictionReturn, required bool whatToNoticeNext, required bool betaTodaySummary, required bool openCapturePromptChips, required bool captureFreedomLine, required bool timelineProofMoment, required bool archiveTimelineSpine, required bool timelinePositioning, required bool currentRelevance, required bool correctionMemory, required bool notRelevantRecovery, required bool proofQualityResponse, required bool evidenceWeighting, required bool proofSpecificity, required bool presentDayRelevance, required bool patternConfidence, required bool betaTesterReport, required bool proEvidenceValue, required bool privateReportProBridge, required bool suppressLegacyEducation, bool threeMomentCompletion = false,
  ...
  factory SurfacePriorityCandidates.recordPostSave({
    ...
    required bool proEvidenceValue, required bool proLockMoment, required bool privateReportProBridge, bool betaInviteLoop = false,
    bool betaFeedbackCapture = false,
    bool betaProofLift = false,
    bool returnAfterProofStrengthened = false,
    bool returnAfterProof = false,
  ...
  factory SurfacePriorityCandidates.patterns({
    ...
    required bool patternConfidence, required bool evidenceWeighting, required bool currentRelevance, required bool proofSpecificity, required bool presentDayRelevance, required bool timelinePositioning, required bool proEvidenceValue, required bool archiveIntelligenceProBridge, required bool privateReportProBridge, required bool archiveBackupBridge, required bool suppressLegacyEducation, bool betaProofLift = false,
    bool proBridgeVisibility = false,
    bool proofFloorRescue = false,
    bool proPreview = false,
    bool proUnderstandingLift = false,
