...
abstract final class SecretsRotationLaunchGate {
  ...
  static final RegExp _committedSecretPattern = RegExp(
    '(sk_live_[A-Za-z0-9]{8,}|sk_test_[A-Za-z0-9]{16,}|whsec_[A-Za-z0-9]{16,}|'
  ...
  static bool detectNoSecretValuesPrintedInLogs({
    ...
    return !revenueCatServiceSource.contains('AppLogger.debug(apiKey') &&
        !revenueCatServiceSource.contains('AppLogger.debug(_apiKey');
  }
