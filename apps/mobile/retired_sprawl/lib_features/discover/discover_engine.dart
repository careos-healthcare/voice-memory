...
import 'package:archiveme_mobile/features/discover/growth_timeline_engine.dart';
...
class DiscoverYourselfEngine {
  ...
  DiscoverMomentumStats _momentum(
    ...
    var recordingsThisWeek = 0;
    var reflectionsThisWeek = 0;
    for (final e in all) {
  ...
  DiscoverArchiveAnswer _answerWhatChangedMost(
    ...
    return const DiscoverArchiveAnswer(
      prompt: 'What changed most?',
      answerLines: [
  ...
  DiscoverArchiveAnswer _answerRepeating(List<JournalEntry> entries) {
    ...
    final ids = const DiscoverThemeEngine()
