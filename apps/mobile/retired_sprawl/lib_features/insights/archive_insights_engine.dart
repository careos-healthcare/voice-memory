...
import 'package:archiveme_mobile/features/insights/belief_evidence/belief_evidence_engine.dart';
import 'package:archiveme_mobile/features/insights/belief_evolution/belief_evolution_engine.dart';
import 'package:archiveme_mobile/features/insights/blind_spots/blind_spot_engine.dart';
import 'package:archiveme_mobile/features/insights/contradictions/contradiction_engine.dart';
...
class ArchiveInsightsEngine {
  ...
  ArchiveInsightsSnapshot build({
    ...
    final beliefBundles = const BeliefEvidenceEngine().build(
      entries: entries,
