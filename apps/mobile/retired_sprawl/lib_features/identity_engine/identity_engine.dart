...
import 'package:archiveme_mobile/features/contradiction_detection/contradiction_report.dart';
...
IdentityTrait? _beliefBackedTrait(
  ...
  return _traitFromEntries(
    id: 'belief:working',
    title: 'Your archive working belief is forming from reflections',
    entries: entries,
...
String _quoteForEntry(JournalEntry entry) {
  ...
  return obs.isEmpty ? 'Reflection excerpt' : obs;
}
