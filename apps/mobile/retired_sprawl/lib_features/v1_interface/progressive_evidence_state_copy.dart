...
abstract final class ProgressiveEvidenceStateCopy {
  ...
  static const twoTitle = 'Thoughtprint can compare.';
  ...
  static const oneBody =
      'One moment is saved. A second similar moment gives Thoughtprint something to compare.';
  static const twoBody =
      'Two moments are in. One more related moment may let the first thread appear.';
  static const threePlusBody =
      'Around three real moments, Thoughtprint can show what repeated — cautiously, not as a guarantee.';
