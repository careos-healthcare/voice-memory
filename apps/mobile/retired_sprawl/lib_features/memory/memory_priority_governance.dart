...
abstract class MemoryPriorityGovernance {
    ...
    if (userConfirmed && governance.allowsMemoryClaim) {
      return _finish(
        ...
        decision: const MemoryPriorityDecision(
          ...
          reasonIds: [MemoryPriorityReasonId.userConfirmed],
          shouldSuppress: false,
          backgroundOnly: false,
  ...
  static void resetPersistedState() {
    MemoryPriorityDecisionLog.resetPersistedState();
    NotImportantFeedback.resetPersistedState();
  }
