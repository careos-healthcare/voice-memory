...
abstract class ArchiveDiscoveryShareAnalytics {
  ...
  static Future<void> discoveryShareTapped({
    ...
    return ProductAnalytics.trackStrings('discovery_share_tapped', {
  ...
  static Future<void> discoveryShared({
    ...
    await ProductAnalytics.trackStrings('discovery_shared', {
      'card_type': cardType.analyticsValue,
      'card_id': cardId,
      'surface': surface,
