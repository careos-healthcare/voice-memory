...
import '../features/live_audio/application/live_voice_lifecycle_policy.dart';
import '../features/live_audio/application/live_voice_capture_service.dart';
import '../features/live_audio/domain/models/live_voice_error_classifier.dart';
import '../features/live_audio/domain/models/live_voice_error_state.dart';
import '../features/live_audio/domain/models/live_voice_session_fault.dart';
import '../features/live_audio/domain/services/live_pcm16_capture_source.dart';
...
class _LiveVoiceSessionScreenState extends State<LiveVoiceSessionScreen>
  ...
  void initState() {
    ...
    _liveVoice = widget.liveVoiceCapture ?? AppServices.instance.liveVoiceCapture;
    _audioFocusGateway = widget.audioFocusGateway ??
    ...
    switch (state) {
      ...
      case AppLifecycleState.hidden:
        if (LiveVoiceLifecyclePolicy.shouldPauseActiveSession(
          ...
          isConnectingOrActive: _phase == LiveVoiceUiPhase.active ||
      ...
      child: ColoredBox(
        ...
        child: ListenableBuilder(
          ...
          builder: (context, _) {
            ...
            final showActions = (_phase == LiveVoiceUiPhase.active ||
                    _phase == LiveVoiceUiPhase.starting) &&
                !_liveVoice.hasError;
            ...
            return SafeArea(
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  actions: [
                    LiveVoiceConnectionPill(visualState: visualState),
                  ],
                ),
                body: Stack(
                  children: [
                          ...
                          Expanded(
                            child: ListView(
                              children: [
                                ...
                                if (showSaving) ...[
                                  PostSaveListeningCard(stageLabel: _stageLabel),
                                ] else ...[
                                  LiveVoiceTranscriptPreview(transcript: _transcript),
                                ],
                              ],
                            ),
                          ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: FilledButton.icon(
                                    ...
                                    label: const Text(LiveVoiceSessionCopy.stopAndSave),
                                  ),
                                ),
                              ],
                            ),
