...
import '../features/archive_export/archive_export_pack.dart';
import '../features/archive_export/archive_export_pack_copy.dart';
...
class _ArchiveExportScreenState extends State<ArchiveExportScreen> {
  ...
  Future<void> _shareExport() async {
    ...
    try {
      ...
      setState(
        () => _message =
            'Export ready (${pack.savedMomentCount} saved moments).',
      );
    } catch (e) {
      if (!mounted) return;
      setState(
