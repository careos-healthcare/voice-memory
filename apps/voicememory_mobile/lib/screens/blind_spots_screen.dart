...
class BlindSpotsScreen extends StatefulWidget {
  const BlindSpotsScreen({super.key});

  @override
  State<BlindSpotsScreen> createState() => _BlindSpotsScreenState();
}

class _BlindSpotsScreenState extends State<BlindSpotsScreen> {
  ...
  Future<void> _load() async {
    ...
    var ent = PremiumEntitlements.free();
    ...
    try {
      ...
      ent = await s.billing.loadEntitlements();
