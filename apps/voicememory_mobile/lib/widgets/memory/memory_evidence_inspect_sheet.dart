...
import '../../features/memory/archive_evidence_type.dart';
import '../../features/memory/curated_memory_marker.dart';
import '../../features/memory/curated_memory_preservation_policy.dart';
...
import 'memory_surfacing_editor.dart';
import 'original_evidence_block.dart';
import 'preserve_original_control.dart';
import '../fact_ledger/save_as_fact_button.dart';
import 'sensitive_surfacing_notice.dart';
...
class MemoryEvidenceInspectSheet extends StatefulWidget {
  const MemoryEvidenceInspectSheet({super.key, required this.cardType});
            ...
            if (_sourceEntry != null) ...[
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: Text(CuratedMemoryCopy.openEntryLabel),
                ),
              ),
              const SizedBox(height: AppSpacing.sm),
              SaveAsFactButton(
              ...
              Wrap(
                ...
                children: [
                  OutlinedButton(
                    ...
                    child: Text(MemoryEvidenceInspectCopy.keepConnectedLabel),
                  ),
                  OutlinedButton(
                    key: const Key('memory_inspect_not_related_action'),
                    onPressed: _notRelated,
                    child: Text(MemoryEvidenceInspectCopy.notRelatedLabel),
                  ),
                  OutlinedButton(
                    key: const Key('memory_future_fresh_action'),
                    onPressed: _futureFresh,
                    child: Text(MemoryEvidenceInspectCopy.futureFreshLabel),
                  ),
                ],
              ),
            const SizedBox(height: AppSpacing.sm),
