...
import '../../features/early_archive/positive_pattern_models.dart';
...
class PositivePatternCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final evidenceStyle = ArchiveMobileTypography.explanationBody(context).copyWith(
          ...
          if (showRecordAgainCta && onRecordAgain != null) ...[
            ...
            Align(
              ...
              child: TextButton(
                ...
                child: Text(PositivePatternCopy.recordAgainCta),
              ),
            ),
          ],
        ],
