...
import '../../features/beta_feedback_intelligence/beta_feedback_intelligence_analytics.dart';
import '../../features/beta_feedback_intelligence/beta_feedback_intelligence_copy.dart';
...
import 'beta_feedback_intelligence_sheet.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          FilledButton(
            ...
            child: Text(BetaFeedbackIntelligenceCopy.cardCta),
          ),
        ],
      ),
    );
