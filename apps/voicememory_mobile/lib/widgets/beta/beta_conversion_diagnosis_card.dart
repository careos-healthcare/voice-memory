...
import '../../features/beta_conversion_diagnosis/beta_conversion_diagnosis_copy.dart';
import '../../features/beta_conversion_diagnosis/beta_conversion_diagnosis_engine.dart';
import '../../features/beta_conversion_diagnosis/beta_conversion_diagnosis_model.dart';
        ...
        children: [
          ...
          if (!result.hasDiagnoses)
            Text(
              ...
              key: const Key('beta_conversion_diagnosis_no_issues'),
              style: const TextStyle(
                color: AppTheme.muted,
                fontSize: 13,
                height: 1.4,
          ...
          Text(
            ...
            key: const Key('beta_conversion_diagnosis_note'),
            style: const TextStyle(
              color: AppTheme.muted,
              fontSize: 12,
              height: 1.35,
