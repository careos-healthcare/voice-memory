...
import '../../features/beta_decision_rules/beta_decision_rule_copy.dart';
import '../../features/beta_decision_rules/beta_decision_rule_engine.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            key: const Key('beta_decision_rule_note'),
            style: const TextStyle(
              color: AppTheme.muted,
              fontSize: 12,
              height: 1.35,
