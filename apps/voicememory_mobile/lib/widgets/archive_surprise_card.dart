...
import '../features/surprise_engine/surprise_coordinator.dart';
import '../features/surprise_engine/surprise_copy.dart';
import '../features/surprise_engine/surprise_models.dart';
import '../features/surprise_engine/surprise_analytics.dart';
...
class _ArchiveSurpriseCardState extends State<ArchiveSurpriseCard> {
  ...
  void _openTimeline() {
    ...
    if (s.type == SurpriseType.newLifeChapter &&
      ...
      context.push('/discover-yourself/chapter/${s.chapterId}');
      return;
    }
    context.push('/discover-yourself');
  }
