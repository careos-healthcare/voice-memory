...
const Map<MomentTag, List<String>> _keywords = {
  MomentTag.work: ['work', 'job', 'meeting', 'deadline', 'boss', 'office',
      'shift', 'colleague'],
  MomentTag.family: ['family', 'mum', 'mom', 'dad', 'mother', 'father',
      'parent', 'kids', 'child', 'sister', 'brother', 'son', 'daughter'],
  MomentTag.partner: ['partner', 'husband', 'wife', 'boyfriend', 'girlfriend',
      'spouse'],
  MomentTag.friend: ['friend', 'mate'],
  MomentTag.money: ['money', 'rent', 'bills', 'salary', 'debt', 'afford',
      'cost', 'broke'],
  MomentTag.sleep: ['sleep', 'slept', 'insomnia', 'awake', 'nap', 'rest',
      'bed'],
  MomentTag.pressure: ['pressure', 'guilt', 'said yes', 'had to', 'should',
      'expected', 'responsibility', 'carry', 'carried'],
  MomentTag.worry: ['worry', 'worried', 'anxious', 'nervous', 'scared',
      'afraid'],
  MomentTag.tired: ['tired', 'exhausted', 'drained', 'no energy', 'burnt out',
      'burned out', 'flat'],
  MomentTag.avoided: ['avoided', 'delayed', 'put off', 'procrastinated',
      'ignored', 'left it'],
