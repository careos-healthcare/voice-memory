...
import 'signal_journey_engine.dart';
import 'signal_journey_model.dart';
import 'signal_journey_store.dart';
...
abstract class SignalJourneyCoordinator {
  ...
  static Future<SignalJourney?> onSignalRejected({
    ...
    final now = DateTime.now();
    var contradicting = List<String>.from(existing.contradictingMomentIds);
  ...
  static SignalJourney _appendSupport(
    ...
    var supporting = List<String>.from(existing.supportingMomentIds);
