...
abstract final class AnnualPlanFutureCopy {
  ...
  static const yearTrailFocusCopy =
      'Keep the longer proof trail for the year.';
  ...
  static const detailBlockedBeforeProof = 'Blocked before monthly purchase proof';
  static const detailFutureAnnualPlanDocumented = 'Future annual plan documented only';
  ...
  static String recommendationFor(AnnualPlanFutureGateDecision decision) =>
      switch (decision) {
...
enum AnnualPlanFuturePrereqStatus {
  pass,
  pending,
  fail,
}
...
enum AnnualPlanFutureRuleStatus {
  pass,
  fail,
}
...
enum AnnualPlanFutureGateDecision {
  annualPlanFrozen,
  annualPlanDocumented,
}
