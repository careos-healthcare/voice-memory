...
/// Local dismiss for "Not today" — UTC day only, no network.
class ReturnAfterProofStore {
  ReturnAfterProofStore(this._prefs);

  static const dismissPrefsKey = 'returnAfterProofDismiss_v1';
  ...
  static ReturnAfterProofStore instance() =>
      ReturnAfterProofStore(AppServices.instance.prefs);

  static ReturnAfterProofStore forPrefs(MobilePrefsStore prefs) =>
      ReturnAfterProofStore(prefs);
