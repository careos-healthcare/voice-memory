...
abstract final class MilestoneShareCopy {
  ...
  static _MilestoneCardCopy cardFor(MilestoneShareId id) => switch (id) {
        ...
        MilestoneShareId.threeMomentsSaved => (
            ...
            share:
                'I saved 3 moments and started seeing what might repeat.',
        ...
        MilestoneShareId.firstWeeklyReview => (
            ...
            share:
                'My archive is now strong enough for a weekly review.',
        ...
        MilestoneShareId.firstRepeatingTheme => (
            ...
            share:
                'ArchiveMe helped me notice my first repeating theme.',
        ...
        MilestoneShareId.firstThenVsNowAvailable => (
            ...
            share:
                'I can now compare earlier and newer moments in ArchiveMe.',
        ...
        MilestoneShareId.archiveCalendarActive => (
            ...
            share:
                'I\'m building a private archive of what keeps repeating.',
