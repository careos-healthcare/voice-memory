...
abstract final class AdaptiveDailyQuestionCopy {
  ...
  static const confirmedRepeatHelper =
      'ArchiveMe can compare what changed.';
  ...
  static const returnStrongerHelper =
      'ArchiveMe is watching what changes.';

  static const returnSameQuestion = 'Did this feel about the same again?';
  static const returnSameHelper =
      'ArchiveMe compares returns over time.';
