...
import 'early_behavior_loop_copy.dart';
...
class EarlyBehaviorLoopEngine {
  ...
  static const _fallbackEvidence = EarlyBehaviorLoopCopy.evidenceFallback;
  ...
  bool _hasAdjacentSupport(
    ...
    for (var i = 0; i < texts.length; i++) {
      ...
      if (def.signals.any((s) => lower.contains(s))) return true;
    }
    return false;
  }
