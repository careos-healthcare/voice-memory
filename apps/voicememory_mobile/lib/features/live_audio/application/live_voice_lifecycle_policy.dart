...
/// App lifecycle rules for live voice capture pause/resume.
abstract final class LiveVoiceLifecyclePolicy {
  LiveVoiceLifecyclePolicy._();
  ...
  static bool shouldAttemptCaptureResume({
    ...
    return LiveVoiceLifecyclePolicy.isForegroundForCapture(state) &&
        sessionActive &&
        !hasError &&
        !isSaving;
  }
