...
import '../activation/return_day_friction_model.dart';
...
import '../retention/retention_diagnosis_snapshot.dart';
...
class TrialSummaryModel {
  const TrialSummaryModel({
    ...
    required this.firstReflectionSaved,
    required this.firstPatternShown,
    required this.firstPatternAccepted,
    required this.firstPatternCorrected,
    required this.watchForPromptShown,
    required this.watchForPromptAccepted,
    required this.returnCaptureQuickAnswerSelected,
    required this.returnedNextDay,
    required this.secondReflectionSaved,
    required this.comparisonViewed,
    required this.usefulnessYes,
    required this.usefulnessSortOf,
    required this.usefulnessNotReally,
    required this.thirdReflectionSaved,
    required this.appOpenedCount,
    required this.recordCtaTappedCount,
    required this.recordingStartedCount,
    required this.recordingSavedCount,
    required this.micDeniedCount,
    required this.saveCompletedCount,
    required this.closedBeforeWatchForAcceptedCount,
    required this.trialFrictionVerdict,
    required this.checkInCreatedCount,
    required this.checkInDueShownCount,
    required this.checkInOptionSelectedCount,
    required this.checkInCompletedCount,
