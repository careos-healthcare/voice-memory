...
/// Session + daily dismiss for the archive preservation bridge.
abstract final class ArchiveBackupBridgeDismissStore {
  ArchiveBackupBridgeDismissStore._();

  static const prefsKey = 'archiveBackupBridgeDismissedDateKey_v1';
