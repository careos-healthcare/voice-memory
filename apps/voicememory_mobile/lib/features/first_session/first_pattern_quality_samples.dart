import 'first_pattern_quality_messy_samples.dart';
...
abstract final class FirstPatternQualitySamples {
  ...
  static List<FirstPatternQualitySample> get curated => [
        ...core,
        ...ambiguous,
      ];
  ...
  static List<FirstPatternQualitySample> get hard => [
        ...curated,
        ...messy,
      ];
  ...
  static List<FirstPatternQualitySample> get responsibility => [
        ...
        _core(
          id: 'resp-3',
          text: 'I should have asked sooner instead of saying yes and feeling guilty',
          category: 'responsibility',
        ),
        _core(
          id: 'resp-4',
  ...
  static List<FirstPatternQualitySample> get worry => [
        ...
        _core(
          id: 'worry-3',
          text:
              'Anxious all day, stressed, replaying the conversation in my head',
          category: 'worry',
        ),
        _core(
          id: 'worry-4',
  ...
  static List<FirstPatternQualitySample> get relationship => [
        ...
        _core(
          id: 'rel-2',
          text: 'Argument with my mum left me upset and replaying what I should say',
          category: 'relationship',
        ),
        _core(
          id: 'rel-3',
  ...
  static List<FirstPatternQualitySample> get selfDoubt => [
        ...
        _core(
          id: 'doubt-3',
          text:
              'I doubt myself whenever I compare my progress and lose confidence',
          category: 'selfDoubt',
        ),
        _core(
          id: 'doubt-4',
          text:
              'Trying to prove I am capable but worried I am not good enough',
          category: 'selfDoubt',
        ),
        _core(
          id: 'doubt-5',
  ...
  static List<FirstPatternQualitySample> get avoidance => [
        ...
        _core(
          id: 'avoid-3',
          text:
              'I delayed the task and froze, overwhelmed by how much is left',
          category: 'avoidance',
        ),
        _core(
          id: 'avoid-4',
          text:
              'Put off what matters again, stuck before I even open the document',
          category: 'avoidance',
        ),
        _core(
          id: 'avoid-5',
          text:
              'I said I would do it tomorrow but I am avoiding starting tonight',
          category: 'avoidance',
        ),
        _core(
          id: 'avoid-6',
  ...
  static List<FirstPatternQualitySample> get burnout => [
        ...
        _core(
          id: 'burnout-3',
          text:
              'No energy left, drained after too much, sleep did not help',
          category: 'burnout',
        ),
        _core(
          id: 'burnout-4',
          text:
              'Feeling flat and heavy, exhausted before the day even started',
          category: 'burnout',
        ),
        _core(
          id: 'burnout-5',
