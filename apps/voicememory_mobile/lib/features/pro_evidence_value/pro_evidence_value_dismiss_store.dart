...
/// Session + daily dismiss for the Pro evidence value bridge.
abstract final class ProEvidenceValueDismissStore {
  ProEvidenceValueDismissStore._();

  static const prefsKey = 'proEvidenceValueDismissedDateKey_v1';
