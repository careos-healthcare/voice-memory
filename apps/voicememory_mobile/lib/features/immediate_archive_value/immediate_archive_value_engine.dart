...
ArchiveMomentumInsight buildArchiveMomentum(List<JournalEntry> entries) {
  ...
  return ArchiveMomentumInsight(
    ...
    body:
        ...
        'reflection before generating a working belief.',
  );
}
  ...
  switch (themeId) {
    case 'career':
      if (_hasAny(blob, ['uncertain', 'uncertainty', 'unsure', 'not sure'])) {
        return 'You spent most of this reflection discussing career uncertainty.';
      }
      return 'You spent most of this reflection talking about career.';
    case 'approval':
      return "You repeatedly returned to approval and other people's opinions.";
    case 'confidence':
      if (_hasAny(blob, ['doubt', 'uncertain', 'unsure'])) {
        return 'You focused on doubt and confidence in this reflection.';
      }
      return 'You focused on confidence in this reflection.';
    case 'relationships':
      return 'You spent most of this reflection talking about relationships.';
    case 'health':
      return 'You spent most of this reflection talking about health and stress.';
    case 'money':
      return 'You spent most of this reflection talking about money.';
    case 'avoidance':
      return 'You spent most of this reflection talking about avoidance.';
    default:
      final name = ThemeTrackerService.displayNames[themeId] ?? themeId;
      return 'You spent most of this reflection talking about ${name.toLowerCase()}.';
  }
}
