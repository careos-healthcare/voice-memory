...
class WeeklyArchiveWeekReviewResult {
  const WeeklyArchiveWeekReviewResult({
    ...
    required this.changedLine,
    required this.changedIsFallback,
    required this.helpedLine,
    required this.helpedIsFallback,
    required this.nextToWatchLine,
    required this.guidedRecordPrompt,
    required this.hasRepeat,
    required this.hasChange,
    required this.hasPositivePattern,
  });
