...
abstract final class ArchiveGrowthMetricsCopy {
...
abstract final class ArchiveJourneyCopy {
  ...
  static const String day1Pending = 'Record once to unlock your first observation.';

  static const String day3Title = 'Day 3';
  static const String day3Instruction = 'Keep recording — patterns need repetition.';
  static const String day3Pending = 'A few more recordings will surface your first pattern.';

  static const String day7Title = 'Day 7';
  static const String day7Instruction = 'A week of evidence lets the archive show change.';
  static const String day7Pending = 'Return across a week to see your first change.';
