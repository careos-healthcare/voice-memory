...
Support materials for TestFlight testers and internal QA **while waiting for Transporter**. Documentation only — no product feature work in this folder.
...
## Related repo docs (outside `docs/beta/`)

- `docs/TESTFLIGHT_BUILD_NOTES.md` — build and upload commands  
- `docs/TESTFLIGHT_CHECKLIST.md` — submission checklist  
- `docs/TESTFLIGHT_TESTER_SCRIPT.md` — longer 6-entry proof journey  
- `docs/BETA_TESTER_MESSAGE.md` — copy/paste invite message  
- `docs/APP_REVIEW_NOTES.md` — App Store reviewer notes  
- `docs/PRIVACY_CHECKLIST.md` — privacy review  

---

## Release quality bar

- Release suite: **+413 all tests passed** (see [BETA_RELEASE_STATUS.md](./BETA_RELEASE_STATUS.md))  
- Do **not** add features until first beta feedback is triaged  

Feedback email: **Settings → Testing ArchiveMe? → Send feedback** → `hello@careosapp.co.uk`
