...
import 'package:voicememory_mobile/features/activation/watch_for_prompt_metrics_store.dart';
...
void main() {
  ...
  test('activation summary includes return capture metrics', () async {
    ...
    await ActivationTracker.trackReturnCaptureQuickAnswerSelected(
      quickAnswerId: 'felt_lighter',
      comparisonHint: 'lighter',
    );
    await ActivationTracker.trackReturnCaptureQuickAnswerSelected(
      quickAnswerId: 'showed_up_again',
      comparisonHint: 'same',
    );
