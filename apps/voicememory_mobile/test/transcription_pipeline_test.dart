...
class _TranscriptionPipelineFakeApi extends ApiClient {
...
void main() {
  ...
  group('TranscriptionService', () {
    test('active mode is server because local iOS is not implemented', () {
      expect(
        TranscriptionService.localIosSpeechRecognitionImplemented,
        isFalse,
      );
