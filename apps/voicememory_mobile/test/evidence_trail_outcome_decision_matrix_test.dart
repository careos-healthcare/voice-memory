...
import 'package:voicememory_mobile/features/evidence_trail_clarity/evidence_trail_outcome_decision_copy.dart';
import 'package:voicememory_mobile/features/evidence_trail_clarity/evidence_trail_outcome_decision_matrix.dart';
...
void main() {
  ...
  group('EvidenceTrailOutcomeDecisionMatrix.resolve', () {
    ...
    test('too vague or not relevant high returns protectProof', () {
      expect(
        EvidenceTrailOutcomeDecisionMatrix.resolve(
          _summary(totalTesters: 30, tooVagueOrNotRelevantCount: 7),
        ),
        EvidenceTrailOutcomeDecision.protectProof,
      );
    });
