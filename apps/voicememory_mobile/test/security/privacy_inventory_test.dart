...
import 'package:voicememory_mobile/security/privacy_inventory.dart';
...
void main() {
  ...
  test('privacy contract promises align with inventory remote processing', () {
    ...
    expect(
      PrivacyContract.canonicalPromises,
      contains(PrivacyContract.journalNotUploadedWithoutConsent),
    );
  });
}
