...
import 'package:voicememory_mobile/features/beta_results_reader/beta_results_reader.dart';
import 'package:voicememory_mobile/features/beta_results_reader/beta_results_reader_copy.dart';
import 'package:voicememory_mobile/features/beta_results_reader/beta_results_summary.dart';
...
void main() {
  ...
  group('BetaResultsReader.resolve branches', () {
    ...
    test('sawPro below target returns proTooHidden', () {
      expect(
        BetaResultsReader.resolve(
          _summary(sawProCount: 3, evidenceTrailClearCount: 5),
        ),
    ...
    test('understandsPro below target returns improveProExplanation', () {
      expect(
        BetaResultsReader.resolve(
          _summary(understandsProCount: 3, evidenceTrailClearCount: 5),
        ),
      ...
      expect(
        BetaResultsReader.resolve(
          _summary(
            paywallCtaTapCount: 0,
            wouldPayYesMaybeCount: 4,
            moreProofOverTimeCount: 0,
            clearerTimelineCount: 0,
            lowerPriceCount: 0,
          ),
        ),
        BetaResultsDecision.improveTimelineExplanation,
