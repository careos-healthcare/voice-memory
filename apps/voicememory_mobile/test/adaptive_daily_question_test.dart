...
import 'package:voicememory_mobile/features/daily_question/adaptive_daily_question_copy.dart';
import 'package:voicememory_mobile/features/daily_question/adaptive_daily_question_engine.dart';
import 'package:voicememory_mobile/features/daily_question/adaptive_daily_question_model.dart';
  ...
  group('AdaptiveDailyQuestionEngine', () {
    ...
    test('phrase max 6 words in confirmed repeat question', () {
      ...
      if (result.usesPhrase) {
        final match = RegExp(r'“([^”]+)”').firstMatch(result.questionText);
    ...
    test('copy avoids advice coaching therapy and personality language', () {
      for (final text in AdaptiveDailyQuestionCopy.allVisibleStrings) {
