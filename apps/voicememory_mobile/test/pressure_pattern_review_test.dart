  ...
  group('Pattern review engine', () {
    ...
    test('change since first entry is detected only when supported', () {
      ...
      final firstStopped = engine.build([
        ...
        _record(id: 'f4', daysAgo: 0, choseToStop: true),
      ]);
