...
import 'package:voicememory_mobile/features/pricing_validation/pricing_outcome_decision_copy.dart';
import 'package:voicememory_mobile/features/pricing_validation/pricing_outcome_decision_matrix.dart';
  ...
  group('PricingOutcomeDecisionMatrix.resolve', () {
    test('total testers below 20 returns insufficientData', () {
      final decision = PricingOutcomeDecisionMatrix.resolve(
        _summary(totalTesters: 19, usefulProofCount: 10),
      );
