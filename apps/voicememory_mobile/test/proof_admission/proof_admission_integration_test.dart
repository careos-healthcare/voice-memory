...
import 'package:voicememory_mobile/features/proof_admission/proof_admission_analytics.dart';
...
const _archive = ProofDisplayGate.defaultArchiveScope;
const _owner = ProofDisplayGate.defaultOwnerScope;
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(view.firstOccurrence, DateTime.utc(2026, 7, 1));
