...
import 'package:voicememory_mobile/features/archive_compression/archive_compression_engine.dart';
...
void main() {
  test('groups by patternTitle when count is at least 3', () {
    ...
    final groups = buildArchiveMomentGroups([
      _moment(id: 'a', date: DateTime(2026, 5, 1), patternTitle: title),
  ...
  test('never auto-hides — all moment ids remain in the group', () {
    final moments = [
      _moment(id: 'a', date: DateTime(2026, 5, 1), patternTitle: 'Pattern'),
