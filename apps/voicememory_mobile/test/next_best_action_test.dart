...
import 'package:voicememory_mobile/features/next_action/next_best_action_engine.dart';
import 'package:voicememory_mobile/features/next_action/next_best_action_gates.dart';
import 'package:voicememory_mobile/features/next_action/next_best_action_model.dart';
import 'package:voicememory_mobile/features/repeat_return_check/repeat_return_check_models.dart';
import 'package:voicememory_mobile/models/journal_entry.dart';
import 'package:voicememory_mobile/models/reflection.dart';
import 'package:voicememory_mobile/widgets/next_action/next_best_action_line.dart';
...
void main() {
  group('NextBestActionEngine', () {
    ...
    test('1 entry shows come back when similar happens', () {
      final result = NextBestActionEngine.build(
        entries: [_entry(id: '1', transcript: 'I felt pressure before saying yes again today.')],
      );
    ...
    test('2 unrelated shows record next real moment', () {
      final result = NextBestActionEngine.build(
        entries: [
          _entry(id: '1', transcript: 'A quiet moment about lunch with a friend today.'),
          _entry(id: '2', transcript: 'Another unrelated note about errands this afternoon.'),
        ],
      );
  ...
  group('NextBestActionLine', () {
    testWidgets('renders title and helper without buttons', (tester) async {
      ...
      expect(find.byKey(const Key('next_best_action_line_record_noEntries')), findsOneWidget);
