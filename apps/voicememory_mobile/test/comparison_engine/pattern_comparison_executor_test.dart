...
void main() {
  ...
  group('PatternComparisonExecutor', () {
    ...
    test('buildComparisonPlan prunes oversized pro history before prompt build',
        () {
      const prunedExecutor = PatternComparisonExecutor(maxHistoricalContextItems: 30);
      final history = [
    ...
    test('buildEvidenceViewState uses parsed PatternState for ProTrailGate', () {
      final plan = executor.buildComparisonPlan(
        currentMoment: _moment(
          id: 'current',
      ...
      expect(viewState.pastQuote, 'I said yes again before I checked my calendar.');
    ...
    test('parsed notEnoughEvidence suppresses pro prompt even with enough moments',
        () {
      final plan = executor.buildComparisonPlan(
        currentMoment: _moment(
          id: 'current',
