...
void main() {
  ...
  group('ProofToProPathEngine sequencing', () {
    test('proof clarity is shown before Pro packaging on proPackaging branch', () {
      expect(
    ...
    test('suppresses standalone Pro bridge when proof card carries inline bridge', () {
      final path = ProofToProPathEngine.build(
        entryCount: 3,
        hasMeaningfulProof: true,
  ...
  group('Pack engine integration', () {
    test('proPackaging branch exposes paired bridge lines after meaningful proof', () {
