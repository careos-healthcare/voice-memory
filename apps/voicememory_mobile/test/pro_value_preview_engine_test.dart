...
void main() {
  ...
  test('keyMomentSearch preview uses memory-limit copy', () {
    final preview =
        buildProValuePreview(_context(PaywallTrigger.keyMomentsLimit));
  ...
  test('patternMap preview copy', () {
    final preview = buildProValuePreview(_context(PaywallTrigger.patternMapFull));
    expect(preview.type, ProValuePreviewType.patternMap);
    expect(preview.title, 'Unlock your full pattern map');
  ...
  test('archiveTimeline preview copy', () {
    final preview =
        buildProValuePreview(_context(PaywallTrigger.archiveTimelineFull));
    expect(preview.type, ProValuePreviewType.archiveTimeline);
    expect(preview.title, 'Unlock your archive timeline');
  ...
  test('archiveMemory preview copy', () {
    final preview =
        buildProValuePreview(_context(PaywallTrigger.archiveMemoryFull));
    expect(preview.type, ProValuePreviewType.archiveMemory);
    expect(preview.title, 'Unlock what ArchiveMe remembers');
  ...
  test('monthlyReview preview copy', () {
    final preview = buildProValuePreview(_context(PaywallTrigger.monthlyReview));
  ...
  test('privateExport preview copy', () {
    final preview = buildProValuePreview(_context(PaywallTrigger.privateExport));
