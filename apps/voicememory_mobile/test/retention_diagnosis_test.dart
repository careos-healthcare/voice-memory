...
import 'package:voicememory_mobile/features/quality/interpretation_quality_signal_engine.dart';
import 'package:voicememory_mobile/features/quality/interpretation_quality_signal_model.dart';
import 'package:voicememory_mobile/features/quality/interpretation_quality_store.dart';
import 'package:voicememory_mobile/features/reminders/reminder_timing_engine.dart';
import 'package:voicememory_mobile/features/reminders/reminder_timing_model.dart';
import 'package:voicememory_mobile/features/reminders/reminder_timing_store.dart';
...
import 'package:voicememory_mobile/features/retention/return_reason_capture_store.dart';
...
void main() {
  ...
  group('retention diagnosis v2', () {
    ...
    test('reminder accepted no return', () {
      final result = engine.diagnose(
        _input(reminderAccepted: true, second: false),
      );
      expect(result.bottleneck, RetentionBottleneckV2.reminderAcceptedNoReturn);
    });

    test('no third moment', () {
      final result = engine.diagnose(_input(second: true, third: false));
