  ...
  group('CognitiveAnalyzer', () {
    ...
    group('lexical diversity', () {
      test('returns 1.0 for three or fewer words', () {
        ...
        expect(
          analyzer.analyzeTranscript('hello world').lexicalDiversity,
          1.0,
        );
        expect(
      ...
      test('computes unique words divided by total words', () {
        ...
        expect(
          analyzer
              .analyzeTranscript('the cat sat on the mat')
              .lexicalDiversity,
          closeTo(5 / 6, 0.0001),
        );
        expect(
    ...
    group('cohesion drift', () {
      ...
      test('scores higher on disjointed sentence patterns', () {
        ...
        final disjointedScore =
            analyzer.analyzeTranscript(disjointed).cohesionDrift;
    ...
    group('emotional volatility', () {
      test('returns higher scores for emphatic transcripts', () {
        ...
        final calmScore =
            analyzer.analyzeTranscript(calm).emotionalVolatility;
        final emphaticScore =
            analyzer.analyzeTranscript(emphatic).emotionalVolatility;
    ...
    test('enrichEntry attaches biomarkers to journal entries', () {
      ...
      expect(enriched.biomarkers, analyzer.analyzeTranscript('the the the cat'));
    });
  });
});
}
