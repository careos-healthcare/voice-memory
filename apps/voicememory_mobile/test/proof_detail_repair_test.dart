...
void main() {
  ...
  group('ProofDetailRepairCopy', () {
    test('detail title is Why ArchiveMe noticed this', () {
      expect(ProofDetailRepairCopy.title, 'Why ArchiveMe noticed this');
    });
    ...
    test('detail includes required explanation lines', () {
      ...
      expect(body, contains(ProofDetailRepairCopy.specificEnoughLine));
      expect(body, contains(ProofDetailRepairCopy.importanceLine));
