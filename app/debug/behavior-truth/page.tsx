    ...
    <div className="min-h-screen-mobile bg-zinc-950 pb-safe">
      <div className="mx-auto max-w-3xl px-4 pb-20 sm:px-6">
        ...
        <div className="mt-10 flex flex-wrap gap-3 text-sm">
          <Link href="/debug/retention-readout" className="text-violet-300 hover:text-violet-200">
            Retention readout →
          </Link>
          <Link href="/debug/retention-core" className="text-zinc-500 hover:text-zinc-300">
            Core metrics →
          </Link>
          <Link href="/debug/mobile-readiness" className="text-zinc-500 hover:text-zinc-300">
            Mobile readiness →
          </Link>
        </div>
      </div>
