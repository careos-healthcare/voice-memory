    ...
    >
      <section className="rounded-2xl border border-violet-400/20 bg-violet-500/10 p-5">
        ...
        <p className="mt-3 text-xs leading-relaxed text-zinc-500">
          For data deletion requests, include the browser/device you used and approximate
          dates. We cannot retrieve local-only data from our servers — use{" "}
          <Link href="/settings" className="text-violet-300 hover:text-violet-200">
            Settings
          </Link>{" "}
          to delete on-device immediately.
        </p>
      </section>
