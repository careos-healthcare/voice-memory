...
import { CommercialReadinessPanel } from "@/components/internal/CommercialReadinessPanel";
import { SiteHeader } from "@/components/SiteHeader";
import { buildAppleStoreReadinessReport } from "@/lib/mobile/commercial-evidence";
import { buildMobilePrimaryPlatformReport } from "@/lib/mobile/mobile-primary-platform";

export default function AppleStoreReadinessPage() {
  const report = buildAppleStoreReadinessReport();
      ...
      <div className="mx-auto max-w-3xl px-4 pb-20 sm:px-6">
        ...
        <header className="mt-2">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            Evidence-driven checklist — commit JSON under mobile/evidence/ after physical tests.
          </p>
        ...
        <div className="mt-6">
          <CommercialReadinessPanel report={report} title="Apple App Store" />
        </div>
