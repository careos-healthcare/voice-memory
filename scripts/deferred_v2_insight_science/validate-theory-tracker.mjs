...
const { buildTheoriesForEval, buildTheoryTrackerReport } = await import(
  "../../packages/shared/lib/theories/theory-generation.ts"
);
...
} = await import("../../packages/shared/lib/theories/theory-uncertainty.ts");
...
const required = [
  ...
  "apps/web/app/internal/theory-discovery/page.tsx",
  "apps/web/components/theories/TheoriesView.tsx",
  "apps/web/components/theories/TheoryCard.tsx",
  "apps/web/components/theories/TheoryUnderReviewPanel.tsx",
  "packages/shared/lib/theories/theory-uncertainty.ts",
...
if (!fs.existsSync(path.join(ROOT, "apps/web/app/theories/page.tsx"))) {
  failures.push("/theories route missing");
}
if (!fs.existsSync(path.join(ROOT, "apps/web/app/internal/theory-discovery/page.tsx"))) {
  failures.push("/internal/theory-discovery route missing");
}

const theoriesPage = fs.readFileSync(path.join(ROOT, "apps/web/app/theories/page.tsx"), "utf8");
...
const theoryCardSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/theories/TheoryCard.tsx"),
  "utf8",
);
const changeCardSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/discover/TheoryChangeItemCard.tsx"),
  "utf8",
);
...
const panelSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/theories/TheoryUnderReviewPanel.tsx"),
  "utf8",
);
for (const id of [
...
if (!fs.existsSync(path.join(ROOT, "packages/shared/lib/theories/theory-uncertainty.ts"))) {
