...
const required = [
  "packages/shared/types/insight-ingredient-optimizer.ts",
...
const panelSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/internal/InsightIngredientOptimizerPanel.tsx"),
  "utf8",
);
...
const rankingSrc = fs.readFileSync(
  path.join(ROOT, "packages/shared/lib/blind-spots/blind-spot-ranking.ts"),
  "utf8",
);
if (
