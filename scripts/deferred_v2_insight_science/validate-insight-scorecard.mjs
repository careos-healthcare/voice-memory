...
} = await import("../../packages/shared/lib/insights/insight-scorecard.ts");
...
const reviewSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/blind-spots/BlindSpotReview.tsx"),
  "utf8",
);
const theorySrc = fs.readFileSync(path.join(ROOT, "apps/web/components/theories/TheoryCard.tsx"), "utf8");
...
const panelSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/insights/InsightScorecardPanel.tsx"),
  "utf8",
);
