...
} = await import("../../packages/shared/lib/theories/theory-notification-generator.ts");
const {
...
} = await import("../../packages/shared/lib/theories/theory-notification-storage.ts");
const {
...
const {
  ...
  copyForNotification,
} = await import("../../packages/shared/lib/theories/theory-notification-copy.ts");
...
const required = [
  "packages/shared/types/theory-notification.ts",
  "packages/shared/lib/theories/theory-notification-generator.ts",
  "packages/shared/lib/theories/theory-notification-storage.ts",
  "packages/shared/lib/theories/theory-notification-copy.ts",
  "apps/web/components/theories/TheoryUpdatesNav.tsx",
  "apps/web/components/theories/TheoryNotificationCard.tsx",
...
for (const rel of required) {
  ...
  } else if (!fs.readFileSync(path.join(ROOT, "packages/shared/lib/theories/theory-notification-storage.ts"), "utf8").includes(rel)) {
    failures.push(`storage must use ${rel}`);
  }
}

const pageSrc = fs.readFileSync(path.join(ROOT, "apps/web/app/updates/page.tsx"), "utf8");
