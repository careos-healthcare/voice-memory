...
// Dashboard wiring
const panelPath = path.join(ROOT, "apps/web/components/internal/NotificationEffectivenessPanel.tsx");
const theoryPanelPath = path.join(ROOT, "apps/web/components/internal/TheoryDiscoveryPanel.tsx");
...
if (!fs.existsSync(path.join(ROOT, "packages/shared/lib/theories/notification-effectiveness.ts"))) {
