...
} = await import("../../packages/shared/lib/discover/theory-volatility.ts");
...
const { clearTheoryEventsForEval } = await import("../../packages/shared/lib/theories/theory-events.ts");
...
const volatilityPanelSrc = fs.readFileSync(
  path.join(ROOT, "apps/web/components/internal/TheoryVolatilityPanel.tsx"),
  "utf8",
);
