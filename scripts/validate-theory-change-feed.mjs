...
const { buildSurfacePrimaryReport, countDiscoverOpens } = await import(
  "../lib/discover/surface-primary-report.ts"
);
...
const required = [
  ...
  "lib/discover/surface-primary-report.ts",
  "components/internal/SurfacePrimaryPanel.tsx",
];
...
const discoverPage = fs.readFileSync(path.join(ROOT, "app/discover/page.tsx"), "utf8");
