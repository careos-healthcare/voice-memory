...
export const INSPECTED_MOBILE_PATHS = [
  ...
  "apps/mobile/lib/screens/journal_screen.dart",
  "apps/mobile/lib/screens/privacy_screen.dart",
  "apps/mobile/lib/screens/paywall_screen.dart",
  "apps/mobile/lib/screens/action_items_screen.dart",
  "apps/mobile/lib/screens/fact_ledger_screen.dart",
  "apps/mobile/lib/screens/archive_packs_screen.dart",
  "apps/mobile/lib/widgets/retention/*",
  "apps/mobile/lib/widgets/aha/*",
  "apps/mobile/lib/widgets/trust/*",
  "apps/mobile/lib/widgets/memory/*",
  "apps/mobile/test/* (settings, privacy, record, paywall, search, export, action items, details)",
] as const;
