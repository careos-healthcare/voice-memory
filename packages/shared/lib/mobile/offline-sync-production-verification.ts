...
export function readOfflineSyncEvidence(): OfflineSyncEvidence | null {
  ...
  try {
    ...
    return {
      ...
      marketing_version:
        typeof parsed.marketing_version === "string" ? parsed.marketing_version : undefined,
      build_number:
        parsed.build_number !== undefined && parsed.build_number !== null
          ? parsed.build_number
          : undefined,
      commit_sha: typeof parsed.commit_sha === "string" ? parsed.commit_sha : undefined,
    };
  } catch {
    return null;
  }
