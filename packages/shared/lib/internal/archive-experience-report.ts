...
export function buildArchiveExperienceReport(): ArchiveExperienceReport {
  ...
  const mobileTemplate = read("apps/mobile/lib/widgets/archive_mobile_page_template.dart");
  const mobileArchive = read("apps/mobile/lib/screens/archive_belief_screen.dart");
  let mobilePass = 0;
