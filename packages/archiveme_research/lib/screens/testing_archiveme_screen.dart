...
import 'package:archiveme_mobile/features/beta_decision/beta_tester_outcome_store.dart';
...
import 'package:archiveme_mobile/features/beta_test_script/beta_test_script_engine.dart';
...
import 'package:archiveme_mobile/widgets/account/beta_readiness_check_sheet.dart';
import 'package:archiveme_mobile/widgets/account/beta_test_script_sheet.dart';
...
import 'package:archiveme_mobile/widgets/beta/beta_feedback_summary_card.dart';
...
import 'package:archiveme_mobile/widgets/beta/beta_improvement_active_branch_card.dart';
import 'package:archiveme_mobile/widgets/beta/beta_next_build_decision_card.dart';
import 'package:archiveme_mobile/widgets/beta/beta_tester_outcome_log_card.dart';
import 'package:archiveme_mobile/widgets/beta/beta_validation_decision_matrix_card.dart';
import 'package:archiveme_mobile/widgets/beta/beta_fix_playbook_card.dart';
import 'package:archiveme_mobile/widgets/beta/beta_repair_lab_card.dart';
import 'package:archiveme_mobile/widgets/beta/pro_placement_trigger_audit_card.dart';
import 'package:archiveme_mobile/widgets/pro/paywall_value_repair_card.dart';
import 'package:archiveme_mobile/features/paywall_value_repair/paywall_value_repair_copy.dart';
import 'package:archiveme_mobile/features/paywall_value_repair/paywall_value_repair_model.dart';
...
import 'package:archiveme_mobile/widgets/pro/pricing_validation_card.dart';
...
import 'package:archiveme_mobile/widgets/beta/revenue_readiness_dashboard_v2_card.dart';
...
import 'package:archiveme_mobile/features/beta_activation_path/beta_activation_path_engine.dart';
import 'package:archiveme_mobile/widgets/beta/beta_activation_path_card.dart';
import 'package:archiveme_mobile/features/beta_feedback_capture/beta_feedback_capture_copy.dart';
import 'package:archiveme_mobile/features/beta_feedback_capture/beta_feedback_capture_engine.dart';
import 'package:archiveme_mobile/features/beta_feedback_capture/beta_feedback_capture_model.dart';
import 'package:archiveme_mobile/features/beta_feedback_capture/beta_feedback_capture_store.dart';
import 'package:archiveme_mobile/widgets/beta/beta_feedback_capture_card.dart';
import 'package:archiveme_mobile/features/first_session_proof_repair/first_session_proof_repair_engine.dart';
...
import 'package:archiveme_mobile/features/proof_floor_rescue/proof_floor_rescue_engine.dart';
import 'package:archiveme_mobile/features/proof_floor_rescue/proof_floor_rescue_model.dart';
import 'package:archiveme_mobile/features/first_session_lift/first_session_lift_engine.dart';
...
import 'package:archiveme_mobile/features/pro_understanding_lift/pro_understanding_lift_engine.dart';
...
import 'package:archiveme_mobile/widgets/record/first_session_proof_repair_card.dart';
import 'package:archiveme_mobile/widgets/proof/proof_floor_rescue_card.dart';
import 'package:archiveme_mobile/widgets/record/first_session_lift_card.dart';
...
import 'package:archiveme_mobile/widgets/pro/pro_understanding_lift_card.dart';
...
class _TestingArchiveMeScreenState extends State<TestingArchiveMeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final feedbackSummary = BetaFeedbackIntelligenceEngine.buildSummary(
      entries: _entries,
    );
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.md),
            BetaImprovementActiveBranchCard(compact: true),
            const SizedBox(height: AppSpacing.md),
            ...
            const SizedBox(height: AppSpacing.md),
            const BetaRepairLabCard(source: 'testing_archiveme', compact: true),
            const SizedBox(height: AppSpacing.md),
            ...
            const SizedBox(height: AppSpacing.md),
            _FirstSessionProofRepairTestingPanel(entryCount: _entries.length),
            const SizedBox(height: AppSpacing.md),
            _ProofFloorRescueTestingPanel(entryCount: _entries.length),
            const SizedBox(height: AppSpacing.md),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Repair focus: ${ProofFloorRescueEngine.resolveRepairFocus(const RevenueReadinessDashboardV2Input(testerCount: 10, usefulCount: 1))?.title ?? ProofFloorRescueCopy.dashboardFocusTitle}',
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            key: const Key(
              'testing_archiveme_beta_feedback_capture_unresolved',
            ),
            style: bodyStyle,
          ),
        ],
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text('$label:', key: Key(keyName), style: style),
          ),
