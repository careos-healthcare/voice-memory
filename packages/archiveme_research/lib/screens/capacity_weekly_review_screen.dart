...
import 'package:archiveme_mobile/features/capacity_loop/capacity_weekly_review_engine.dart';
...
import 'package:archiveme_mobile/features/paid_intent/paid_intent_confirmation_engine.dart';
...
import 'package:archiveme_mobile/features/archive_daily_change/archive_daily_change_engine.dart';
import 'package:archiveme_mobile/features/archive_daily_change/archive_daily_change_models.dart';
import 'package:archiveme_mobile/features/archive_daily_change/archive_daily_change_store.dart';
...
import 'package:archiveme_mobile/widgets/paid_intent_confirmation_card.dart';
import 'package:archiveme_mobile/widgets/pushed_screen_shell.dart';
import 'package:archiveme_mobile/widgets/capacity_boundary_response_card.dart';
import 'package:archiveme_mobile/widgets/archive_daily_change_card.dart';
...
class _CapacityWeeklyReviewScreenState
    extends State<CapacityWeeklyReviewScreen> {
  ...
  Future<void> _load() async {
    ...
    final boundaryInput = CapacityBoundaryResponseInput(
      ...
      capacityMomentCount: const CapacityBoundaryResponseEngine().loopEngine
          .eligibleCapacityEntryIds(realEntries)
          .length,
      capacityEvidenceCount: const CapacityBoundaryResponseEngine().loopEngine
    ...
    setState(() {
      ...
      _boundaryResponse = const CapacityBoundaryResponseEngine().build(
        boundaryInput,
      );
      _loading = false;
    });
